(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Y = {}));
  ...
  /* c8 ignore next 2 */
  // @ts-ignore
  const isNode = typeof browser$1 !== 'undefined' && browser$1.release && /node|io\.js/.test(browser$1.release.name) && Object.prototype.toString.call(typeof browser$1 !== 'undefined' ? browser$1 : 0) === '[object process]';
  ...
  const getVariable = (name) =>
    isNode
      ? undefinedToNull(browser$1.env[name.toUpperCase().replaceAll('-', '_')])
  ...
  const forceColor = isNode &&
    isOneOf(browser$1.env.FORCE_COLOR, ['true', '1', '2']);

  /* c8 ignore start */
  const supportsColor = !hasParam('--no-colors') &&
    (!isNode || browser$1.stdout.isTTY || forceColor) && (
