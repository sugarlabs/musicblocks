define(["sugar-web/graphics/palette",
        "text!sugar-web/graphics/menupalette.html", "mustache"], (palette, template, mustache) => {

    'use strict';

    var menupalette = {};

    menupalette.MenuPalette = (invoker, primaryText, menuData) => {
    ...
    var addEventListener = (type, listener, useCapture) => {
