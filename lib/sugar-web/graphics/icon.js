...
var fillColor=iconInfo.fillColor;var strokeColor=iconInfo.strokeColor;if(source.substring(0,4)=='data'){var iconData=decodeURI(source.slice(dataHeader.length));var newData=changeColors(iconData,fillColor,strokeColor);callback(dataHeader+escape(newData));return;}
