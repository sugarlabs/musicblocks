...
We use pre-commit hooks to handle linting and formatting automatically. When you commit your changes, the project will check (and auto-fix) style issues on your staged files.
