...
class GlobalCard {
    ...
    render() {
        ...
        if (projectImage !== null && projectImage !== "")
            ...
            source = (this.ProjectData.ProjectIsMusicBlocks === 1) ?
        ...
        frag.getElementById(likeIconId).textContent =
               (Planet.ProjectStorage.isLiked(this.id)) ? "favorite" : "favorite_border";
