...
describe('RequestManager', () => {
    ...
    describe('generateRequestKey', () => {
        ...
        it('should exclude api-key from key generation', () => {
            const key1 = requestManager.generateRequestKey({ action: 'getProject', 'api-key': 'abc' });
            const key2 = requestManager.generateRequestKey({ action: 'getProject', 'api-key': 'xyz' });
            expect(key1).toBe(key2);
        });
    });
    ...
    describe('resetStats', () => {
        it('should reset all statistics to zero', async () => {
            ...
            await requestManager.throttledRequest(
                { action: 'test' },
