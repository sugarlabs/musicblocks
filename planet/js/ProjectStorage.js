...
function ProjectStorage(Planet) {
    ...
    this.port = async function () {
        let oldProjectData = localStorage.getItem(this.LocalStorageKey);
        let isPortedAlready = await this.get(this.VersionKey);
