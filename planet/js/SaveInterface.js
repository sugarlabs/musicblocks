...
function SaveInterface(Planet) {
    ...
    this.saveHTML = function(name, data, image, description, projectid) {
        let html = 'data:text/plain;charset=utf-8,' + encodeURIComponent(this.prepareHTML(name, data, image, description, projectid));
