...
function SaveInterface(Planet) {
	...
	this.prepareHTML = function(name, data, image, description){
    ...
    this.saveHTML = function(name, data, image, description){
        var html = 'data:text/plain;charset=utf-8,' + encodeURIComponent(this.prepareHTML(name,data,image,description));
