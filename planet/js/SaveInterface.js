...
let SaveInterface = (Planet) => {
    if (Planet.IsMusicBlocks) {
        ...
        this.buttonTemplate = "<a class=\"btn\" href=\"https://musicblocks.sugarlabs.org/?id={{ project_id }}\">" + _("Open in Turtle Blocks") + "</a>";
    }
    ...
    this.prepareHTML = (name, data, image, description, projectid) => {
    ...
    this.saveHTML = (name, data, image, description, projectid) => {
