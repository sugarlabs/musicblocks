...
class SaveInterface {
    ...
    init() {
        ...
        const buttonTemplate = (Planet.IsMusicBlocks) ?
            "<a class=\"btn\" href=\"https://musicblocks.sugarlabs.org/?id={{ project_id }}\">" + _("Open in Music Blocks") + "</a>" : 
            "<a class=\"btn\" href=\"https://musicblocks.sugarlabs.org/?id={{ project_id }}\">" + _("Open in Turtle Blocks") + "</a>" ;  
