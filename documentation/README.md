...
![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/Getting-started-bolck.svg "default blocks")

When you first launch Music Blocks in your browser, you'll see a stack
of blocks representing four notes: `Do 4`, `Mi 4`, `Sol 4` and `Do 5`. The
first note is a `1/2` note; the second and third notes are `1/4` notes; the fourth note is a `1/1` note.
...
![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/Notes-block.svg "the note")
...
![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/Pitch-block.svg "Pitch block")
...
![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/Sol-g-block.svg "Solfege-PitchName blocks")
...
![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/Set-timbre-block.svg "Set timbre block")
...
![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/Set-synth-volume-block.svg "Set synth volume")
...
![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/Set-drum-block.svg "Set drum block")
...
![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/Repeat-block.svg "Repeat")
...
![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/Duplicate-block.svg "Duplicate block")
...
![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/Start-block.svg "Start")
...
![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/Action-chunk-block.svg "Action-Chunk")
...
![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/Storein-box-addone-block.svg "storein-Box-Add One")
...
![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/Forward-block.svg "forward")
...
![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/Right-block.svg "right")
...
![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/Penup-Pendown-block.svg "pen up-pen down")

The *Pen up* and *Pen down* blocks, found on the *Pen* palette,
determine whether or not the mouse draws as it moves.

![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/Setshade-block.svg "set shade")
...
![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/Setcolor-block.svg "set color")
...
![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/Random-block.svg "random")
...
![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/OneOfThisOrThat-block.svg "on of this or that")
...
![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/ShowMedia-block.svg "show media")

The *Show* block, found on the *Media* palette, is used to display
text and images.

![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/MouseButton-block.svg "mousebutton")
...
![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/CursorXCursorY-block.svg "cursorx-cursory")
...
![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/PushPop-block.svg "push-pop")
...
![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/Print-block.svg "print")
...
![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/Pitch-TimeMatrix-block.svg "Pitch-time Matrix blocks")
...
![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/Rythm-block.svg "Rhythm block")
...
![alt tag](https://github.com/Ashnidh/musicblocks/blob/master/documentation/SimpleTuplet-TupletClamp-block.svg "simple Tuplet-Tuplet clamp block")
