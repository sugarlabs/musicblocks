# Manual para programação com Music Blocks
...
é um excelente manual para começar a aprender sobre o básico da programação.  Neste manual, nós ilustramos as características musicais, demonstrando o leitor diversos exemplos.

O Music Blocks [basic documentation](../documentation/README.md) também é um ótimo recurso para adquirir informação sobre o Music Blocks.

E aqui esta um pequeno [Guide to Debugging](../Debugging.md) para te ajudar na sua programação.
