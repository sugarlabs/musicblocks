...
![alt tag](./transform7.svg "swinging notes and tied notes")
...
![alt tag](./TiesChart.svg "using notes with ties")

#### <a name="MORE-TRANSFORMATIONS"></a>3.2.10 Set Volume, Crescendo, Staccato, and Slur

![alt tag](./transform8.svg "Set master volume, set synth volume, set
 relative volume, crescendo")
...
![alt tag](./transform17.svg "Staccato, and Slur blocks")
...
![alt tag](./transform9.svg "Scalar interval block")
...
![alt tag](./transform14.svg "Using absolute intervals")
...
![alt tag](./chordinterval_block.svg "Chord Block")
...
![alt tag](./transform13.svg "inversion")
...
![alt tag](./invert-even.png "even invert example")
...
![alt tag](./odd-invert-chart.svg "odd invert chart")
...
![alt tag](./invert-odd.png "odd invert example")
...
![alt tag](./scalar-invert-chart.svg "scalar invert chart")

In standard notation the result of *scalar* inversion operation is
depicted in the second measure of the following example. The first
measure is the original reference.

![alt tag](./invert-scalar.png "scalar invert example")
...
![alt tag](./transform11.svg "Backward block")
...
![alt tag](./transform19.svg "Define mode block")
...
![alt tag](./transform15.svg "Vibrato, tremelo, chorus, distortion,
 neighbor, and phaser blocks")
...
![alt tag](./voices1.svg "use of voices")

If we put our song into an action...

![alt tag](./voices2.svg "running the song using multiple Start
 blocks")

...we can run it from multiple *Start* blocks.

![alt tag](./voices3.svg "shifting the octaves up and down")

It gets more interesting if we shift up and down octaves.

![alt tag](./voices4.svg "playing the various voices offset in time")
...
![alt tag](./voices5.svg "queuing the various voices using events")
...
![alt tag](./drum3.svg "usage of kick drum")
...
![alt tag](./graphics1.svg "adding graphics")
...
![alt tag](./graphics3.svg "synchronizing graphics and music")
...
![alt tag](./drift_block.svg "No-clock block")
...
![alt tag](./fibonacci3.svg "usage of No-clock block")
...
![alt tag](./graphics4.png "rhythm sequence")

![alt tag](./tree-example.svg "another example of the No-clock block")
...
![alt tag](./beat1.svg "meter and pickup")
...
![alt tag](./beatvalue_block.svg "beat count")

The Measure count block returns the current measure.

![alt tag](./measurevalue_block.svg "measure count")
...
![alt tag](./graphics6.svg "graphics modulated by beat")
...
![alt tag](./interactive.svg "interactions")
...
![alt tag](./interactive2.svg "creation of a two-key piano")
...
![alt tag](./interactive3.svg "adding randomness to your music")
...
![alt tag](./hyperscore.svg "musical paint")
...
![alt tag](./dictionary-pen.svg "mouse pen attributes")
...
![alt tag](./dictionary-graphics.svg "mouse graphics attributes")
...
![alt tag](./number2pitch_block.svg "Generalized converter")
...
![alt tag](./pitchconverter.svg "Pitch converter block")
...
![alt tag](./close-button.svg "close button")

You can hide the widget by clicking on the *Close* button.

![alt tag](./grab-handle.svg "drag handle")
...
![alt tag](./status2.svg "status in tabular form")
...
![alt tag](./status3.svg "additional programming within the Status
 block")
...
![alt tag](./matrix1.svg "phrase maker")
...
![alt tag](./matrix2.svg "Pitch and Rhythm block matrix")
...
![alt tag](./export-chunk.svg "save button")
...
![alt tag](./matrix4.svg "usage of octave for a pitch")
...
![alt tag](./matrix6.svg "the Rhythm block")
...
![alt tag](./matrix7.svg "usage of Rhythm block")
...
![alt tag](./matrix12.svg "embedding rhythm and Tuplet block")
...
![alt tag](./TupletChart.svg "tuplet chart")

![alt tag](./TripletChart.svg "triplet chart")
...
![alt tag](./rhythm1.svg "generating rhythms")
...
![alt tag](./rhythm2.svg "rhythm maker")
...
![alt tag](./rhythm3.svg "usage of rhythm maker")
...
![alt tag](./rhythm4.svg "divide cells in rhythm maker")
...
![alt tag](./rhythm8.svg "tie cells in Rhythm Maker")
...
![alt tag](./mode2.svg "launching widget with Major mode")
...
![alt tag](./mode6.svg "phrase maker block")
...
![alt tag](./meter1.svg "meter widget block")
...
![alt tag](./meter2.svg "Meter Widget")
...
![alt tag](./meter3.svg "on strong beat do blocks")
...
![alt tag](./no-clock.svg "no clock")

### <a name="pitch-drum"></a>4.6 The Pitch-Drum Matrix

![alt tag](./drum2.svg "Pitch-drum matrix")
...
![alt tag](./drum5a.svg "pitch-drum matrix 1")

![alt tag](./drum5.svg "table for pitch-drum matrix")

![alt tag](./drum6.svg "table for pitch-drum matrix")

![alt tag](./drum7.svg "pitch-drum matrix 1")
...
![alt tag](./pitchstaircase0.svg "generating arbitrary pitches")
...
![alt tag](./pitchstaircase1.svg "notes associated with the step in
 the stairs")

![alt tag](./pitchstaircase2.svg "notes associated with the step in
 the stairs")

![alt tag](./pitchstaircase3.svg "notes associated with the step in
 the stairs")
...
![alt tag](./pitchslider0.svg "Pitch Slider")

![alt tag](./pitchslider1.svg "Pitch Slider-One Column")
...
![alt tag](./pitchslider0a.svg "Pitch Slider Block")

![alt tag](./pitchslider2.svg "Pitch Slider-Two Column")

Clicking in a column will extact the corresponding *Note* blocks, for example:

![alt tag](./pitchslider3.svg "Pitch Slider-Two Columns Adjusting")

![alt tag](./pitchslider4.svg " Pitch Slider block")

![alt tag](./pitchslider5.svg " Pitch Slider block")
...
![alt tag](./tempo0.svg "changing tempo")
...
![alt tag](./tempo1.svg "changing tempo")
...
![alt tag](./timbre1.svg "the Timbre widget")
...
![alt tag](./timbre2.svg "the Timbre widget toolbar")
...
![alt tag](./timbre1a.svg "the notes inside Timbre block")
...
![alt tag](./timbre5.svg "set envelope")
...
![alt tag](./timbre6.svg "select effect")

![alt tag](./timbre6a.svg "tremolo")
...
![alt tag](./timbre7.svg "select filter")
...
![alt tag](./keyboard1.svg "keyboard block without clamp")

![alt tag](./keyboard2.svg "keyboard widget without clamp")
...
![alt tag](./temperament1.svg "the Temperament block")
...
![alt tag](./temperament2.svg "the Temperament widget")
...
![alt tag](./temperament3.svg "the Temperament widget")
...
![alt tag](./temperament4.svg "Equal Edit tool")

![alt tag](./temperament4a.svg "Temperament widget with new element")
...
![alt tag](./temperament5.svg "Ratio Edit tool")

![alt tag](./temperament5a.svg "Temperament widget with new element")
...
![alt tag](./temperament6.svg "Arbitrary Edit tool")
...
![alt tag](./temperament7.svg "Octave Space Edit tool")
...
![alt tag](./oscilloscope1.svg "Oscilloscope")

![alt tag](./oscilloscope2.svg "Oscilloscope")

A separate wave will be displayed for each mouse.

###  <a name="sampler"></a>4.14 Sampler

![alt tag](./sampler_block.svg "Sampler")
...
![alt tag](./sampler1.svg "Sampler Widget")

You can then use the *Sample* block as you would any input to the *Set
Instrument* block.

![alt tag](./sampler2.svg "Sampler Widget")
