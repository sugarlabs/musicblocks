...
![alt tag](https://github.com/sugarlabs/musicblocks/blob/master/guide/keyboard1.svg "keyboard without clamp")

When there are *Pitch* blocks inside the widget clamp, a keyboard with
only those pitches is created.

![alt tag](https://github.com/sugarlabs/musicblocks/blob/master/guide/keyboard2.svg "keyboard with pitch block in clamp")
