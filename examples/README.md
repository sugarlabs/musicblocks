...
| el.html                                      | Experimentation with the _One of this or that_ block.                                                          |
...
| Example         | Description                                                                                                                                         |
| --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| test-suite.html | Smoke test for many Music Blocks functions (includes Rhythm, Meter, Pitch, Tone, Graphics, Maths palettes; Beginner and Advanced where applicable). |
