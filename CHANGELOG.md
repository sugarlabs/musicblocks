...
* refactor(styles): consolidate design tokens into tokens.css as single… by @dhruv-prajapati-23 in https://github.com/sugarlabs/musicblocks/pull/8489
...
* fix(mxml): compute real duration and time-modification for tuplet notes by @bhuvan-somisetty in https://github.com/sugarlabs/musicblocks/pull/8560
* refactor(styles): tokenize desktop windows and fix body cascade by @dhruv-prajapati-23 in https://github.com/sugarlabs/musicblocks/pull/8579
* fix(musicutils): align numberToPitchSharp octave with A0 baseline by @Chaitu7032 in https://github.com/sugarlabs/musicblocks/pull/8524
* fix(musicutils): give equal19 all nineteen of its ratios by @kunalKumar-13 in https://github.com/sugarlabs/musicblocks/pull/8588
* fix(deps): update svgo override to resolve security audit by @karankumar1106 in https://github.com/sugarlabs/musicblocks/pull/8597
* chore: add pr description requirement custom check in coderabbit config by @Jetshree in https://github.com/sugarlabs/musicblocks/pull/8370
* fix: stabilize mode widget piemenu and remove musicutils dead code by @021nirav-blip in https://github.com/sugarlabs/musicblocks/pull/8590
* chore: optimize CodeRabbit configuration and remove redundant defaults by @Jetshree in https://github.com/sugarlabs/musicblocks/pull/8622
* fix: pop increscendo array in docrescendo listener by @sreeram5555 in https://github.com/sugarlabs/musicblocks/pull/8602
* fix(rubrics): stop scoring two deprecated blocks in TACAT by @kunalKumar-13 in https://github.com/sugarlabs/musicblocks/pull/8594
* fix: reset tempo widget state when closed (Related to #8581) by @Diwaspant132 in https://github.com/sugarlabs/musicblocks/pull/8583
* fix(mathutils): raise NanError for NaN in every operation that promises it by @kunalKumar-13 in https://github.com/sugarlabs/musicblocks/pull/8589
* test(protoblocks): cover the boolean shapes and BaseBlock.formBlock by @kunalKumar-13 in https://github.com/sugarlabs/musicblocks/pull/8591
* fix(canvas): stop stray tooltips when the bottom buttons are rebuilt by @gouravj25551-afk in https://github.com/sugarlabs/musicblocks/pull/8547
* fix(volume): pass volume, turtle and block to setMasterVolume by @netram75 in https://github.com/sugarlabs/musicblocks/pull/8582
* fix(turtledefs): handle restricted localStorage when retrieving language preference by @dhruvpatil972 in https://github.com/sugarlabs/musicblocks/pull/8566
* docs: update mode widget documentation for scalar builder UI by @021nirav-blip in https://github.com/sugarlabs/musicblocks/pull/8625
* fix(lilypond): place staccato after the duration in tuplet export by @iamtanishqjain in https://github.com/sugarlabs/musicblocks/pull/8630
* chore: remove dead rhythmruler case label in block.js collapse switch (Related to #8456) by @xtroon in https://github.com/sugarlabs/musicblocks/pull/8460
* fix(abc): preserve notes in tuplets by @macayu17 in https://github.com/sugarlabs/musicblocks/pull/8608
* fix: parse bpm input as float in tempo widget by @sreeram5555 in https://github.com/sugarlabs/musicblocks/pull/8605
* fix(blocks): remove disposed block from spatial grid to prevent stale-index crash by @bhuvan-somisetty in https://github.com/sugarlabs/musicblocks/pull/8612
* fix: refresh stale cache in searchIndexForMusicBlock on block ID change by @Sahilbasu5101 in https://github.com/sugarlabs/musicblocks/pull/8556
* fix: stop unbounded Stairs growth on re-init, fix Alt+S while running by @abhnish in https://github.com/sugarlabs/musicblocks/pull/8268
* fix(musicutils): add missing named interval ratios to equal17 by @dolliecoder in https://github.com/sugarlabs/musicblocks/pull/8626
* fix(musicutils): honor a number passed to calcOctave as a string by @rajanpanth in https://github.com/sugarlabs/musicblocks/pull/8425
* chore: remove debug console statements from NumberBlocks.js by @ShivamGupta2003 in https://github.com/sugarlabs/musicblocks/pull/8572
* fix(test): use real equal19 key instead of broken global mock in syntax by @021nirav-blip in https://github.com/sugarlabs/musicblocks/pull/8637
* fix: guard against null cblk1 in OutputToolsBlocks.arg() (#6608) by @abhnish in https://github.com/sugarlabs/musicblocks/pull/8545
* fix(synthutils): restore t.isEDO check for custom EDO temperaments (Related to #8590) by @Diwaspant132 in https://github.com/sugarlabs/musicblocks/pull/8645
* chore: remove debug console statements from ProgramBlocks.js by @Ayush78516 in https://github.com/sugarlabs/musicblocks/pull/8523
* chore: remove debug console statements from ActionBlocks.js by @Ayush78516 in https://github.com/sugarlabs/musicblocks/pull/8670
* fix(js-editor): add heading key and note volume conversions by @severe77 in https://github.com/sugarlabs/musicblocks/pull/8598
* fix(blocks): reject reserved dictionary names by @macayu17 in https://github.com/sugarlabs/musicblocks/pull/8574
* test(cypress): add E2E coverage for block trash and restore flow by @severe77 in https://github.com/sugarlabs/musicblocks/pull/8482
* test(logo): cover semi-tone transpose clamp dispatch through the real interpreter by @vanshika2720 in https://github.com/sugarlabs/musicblocks/pull/8567
* fix(abc): write each note once in ABC export by @iamtanishqjain in https://github.com/sugarlabs/musicblocks/pull/8643
* test(turtle): cover accessors, TurtleModel, and TurtleView by @netram75 in https://github.com/sugarlabs/musicblocks/pull/8450
* test(jseditor): cover the syntax error highlighting path by @kunalKumar-13 in https://github.com/sugarlabs/musicblocks/pull/8617
* fix(turtle): let media follow the turtle instead of a property that is never set by @kunalKumar-13 in https://github.com/sugarlabs/musicblocks/pull/8620
* perf(loader): drop a 5-second startup wait for a global nothing sets by @kunalKumar-13 in https://github.com/sugarlabs/musicblocks/pull/8633
* fix: correct musicxml divisions for quarter-note resolution by @Abhishek-Sonje in https://github.com/sugarlabs/musicblocks/pull/8631
* fix(widgets): resolve Lego Bricks Clear crash and cancel polyphonic playback (Fixes #8609) by @Diwaspant132 in https://github.com/sugarlabs/musicblocks/pull/8611
* feat(tempo): add keyboard shortcuts and ±1 BPM fine-tuning (#8601) by @Diwaspant132 in https://github.com/sugarlabs/musicblocks/pull/8606
* fix(logo): replace embeddedGraphicsFinished boolean with a per-turtle pending count by @bhuvan-somisetty in https://github.com/sugarlabs/musicblocks/pull/8640
* chore: patch npm audit vulnerabilities by @UtkarshAnandd in https://github.com/sugarlabs/musicblocks/pull/8658
* fix: initialize translation helper before splash text by @UtkarshAnandd in https://github.com/sugarlabs/musicblocks/pull/8659
* fix(abc): import rest notes without crashing by @macayu17 in https://github.com/sugarlabs/musicblocks/pull/8661
* fix(blocks): guard the empty denominator slot in noteValueValue by @rakshityadav1868 in https://github.com/sugarlabs/musicblocks/pull/8666
* fix: allow string values in heap entry block by @sreeram5555 in https://github.com/sugarlabs/musicblocks/pull/8603
* refactor(widgets): migrate static visual styles to token-backed classes by @dhruv-prajapati-23 in https://github.com/sugarlabs/musicblocks/pull/8616
* fix(blocks): stop set key crashing when its key slot is empty by @rakshityadav1868 in https://github.com/sugarlabs/musicblocks/pull/8677
* fix(splash): display Turtle Blocks splash screen and loading text in turtle mode by @lavjeetrai in https://github.com/sugarlabs/musicblocks/pull/8686
* fix(CacheManager): use >= in  _isExpired to match clearExpired boundary by @Sahilbasu5101 in https://github.com/sugarlabs/musicblocks/pull/8584
* fix(tempo): remove unreachable dead clearInterval block in init() by @uday-2304 in https://github.com/sugarlabs/musicblocks/pull/8621
* fix(blocks): reject project blocks with truncated connections (#8679) by @akkki007 in https://github.com/sugarlabs/musicblocks/pull/8684
* fix(widgets): ignore stale blockMap entries during arpeggio octave shift by @Sahilbasu5101 in https://github.com/sugarlabs/musicblocks/pull/8667
* fix(logo): thread receivedArg through Switch block's arg selector by @bhuvan-somisetty in https://github.com/sugarlabs/musicblocks/pull/8693
* fix: make trash drops respond immediately by @gouravj25551-afk in https://github.com/sugarlabs/musicblocks/pull/8689
* fix(abc): export tuplets instead of dropping them by @iamtanishqjain in https://github.com/sugarlabs/musicblocks/pull/8694
* feat: enable Kokoro URL flag and show download progress by @7se7en72025 in https://github.com/sugarlabs/musicblocks/pull/8651
* test: increase unit test coverage for timbre widget by @Jetshree in https://github.com/sugarlabs/musicblocks/pull/8656
* test(cypress): cover Tempo widget lifecycle and real-time BPM edit dispatch by @vanshika2720 in https://github.com/sugarlabs/musicblocks/pull/8653
* feat(generate-tests): add --module selection and a richer dry-run preview by @vanshika2720 in https://github.com/sugarlabs/musicblocks/pull/8681
* Remove commented debug statements from rhythmruler by @WKr1shna in https://github.com/sugarlabs/musicblocks/pull/8683
* fix(a11y): resolve axe violations on Planet explore/project-viewer pages (#6608) by @abhnish in https://github.com/sugarlabs/musicblocks/pull/8671
* fix(widgets): add null-safety guards to status matrix render methods by @karankumar1106 in https://github.com/sugarlabs/musicblocks/pull/8595
* fix: use textContent.trim() instead of innerHTML for title comparison in closeBlkWidgets by @Ayush78516 in https://github.com/sugarlabs/musicblocks/pull/8669
* fix(toolbar): keep auxiliary toolbar icons on the toolbar when they wrap by @gouravj25551-afk in https://github.com/sugarlabs/musicblocks/pull/8364
* refactor(styles): convert platformstyle into canvas semantic-theme ad… by @dhruv-prajapati-23 in https://github.com/sugarlabs/musicblocks/pull/8704
* fix(piemenus): let a note name block on its own change its note by @rakshityadav1868 in https://github.com/sugarlabs/musicblocks/pull/8705
* fix(lilypond): correct octave marks for octaves 8 to 10 by @iamtanishqjain in https://github.com/sugarlabs/musicblocks/pull/8707
* fix(blocks): use consistent internal name in TurtleElapsedNotesBlock by @bhuvan-somisetty in https://github.com/sugarlabs/musicblocks/pull/8702
* fix: resolve asset URLs relative to where the app is served (#8685) by @akkki007 in https://github.com/sugarlabs/musicblocks/pull/8708
* fix(block): look up the top block before shift+click runs the stack by @rakshityadav1868 in https://github.com/sugarlabs/musicblocks/pull/8714
* test(activity): make activity.js visible to the coverage report by @kunalKumar-13 in https://github.com/sugarlabs/musicblocks/pull/8563
* fix(help): show the dark Tab Navigation icon in dark themes by @kunalKumar-13 in https://github.com/sugarlabs/musicblocks/pull/8587
* fix(dict): return 0 and show error for unknown key in _GetDict by @uday-2304 in https://github.com/sugarlabs/musicblocks/pull/8717
* perf(loader): load the pie-menu libraries after startup, not before paint by @kunalKumar-13 in https://github.com/sugarlabs/musicblocks/pull/8636
* fix(pitchslider): snap to exact semitone steps to prevent octave drift by @uday-2304 in https://github.com/sugarlabs/musicblocks/pull/8719
* feat(generate-tests): add a candidate review report to --emit by @vanshika2720 in https://github.com/sugarlabs/musicblocks/pull/8716
* feat(blocks): add visual snap indicator when dragging blocks near docks by @karankumar1106 in https://github.com/sugarlabs/musicblocks/pull/8676
* fix(musicutils): align temperament interval tables with playback by @dolliecoder in https://github.com/sugarlabs/musicblocks/pull/8647
...
* @dhruv-prajapati-23 made their first contribution in https://github.com/sugarlabs/musicblocks/pull/8489
* @yashspidey made their first contribution in https://github.com/sugarlabs/musicblocks/pull/8570
* @iamtanishqjain made their first contribution in https://github.com/sugarlabs/musicblocks/pull/8630
* @Sahilbasu5101 made their first contribution in https://github.com/sugarlabs/musicblocks/pull/8556
* @dolliecoder made their first contribution in https://github.com/sugarlabs/musicblocks/pull/8626
* @akkki007 made their first contribution in https://github.com/sugarlabs/musicblocks/pull/8684
* @WKr1shna made their first contribution in https://github.com/sugarlabs/musicblocks/pull/8683
