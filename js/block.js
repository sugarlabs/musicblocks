        ...
        if (this.name === 'text') {
            ...
            if (this.blocks.octaveNumber(blk)) {
                ...
                case 'tremolo':
                    ...
                    break;
                case 'arc':
                    this._piemenuNumber([15, 30, 45, 60, 75, 90, 105, 120, 135, 150, 165, 180, 195, 210, 225, 240, 255, 270, 285, 300, 315, 330, 345, 360], this.value);
                    break;
                case 'rhythmicdot2':
                    this._piemenuNumber([1, 2, 3], this.value);
                    break;
                ...
                case 'articulation':
                    ...
                    break;
                case 'hertz':
                    this._piemenuNumber([220, 247, 262, 294, 330, 355, 392, 440, 494, 530, 590, 660, 700,800,880], this.value);
                    break;
                case 'right':
