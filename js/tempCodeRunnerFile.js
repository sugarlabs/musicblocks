...
// Mock the performance tracker instance before running tests
beforeAll(() => {
...
class Logo {
    ...
    runLogoCommands(startHere, env) {
        // Performance instrumentation: load once and configure
        require(["utils/performanceTracker"], function (performanceTracker) {
            // Store in correct environment (browser or Jest)
            if (typeof window !== "undefined") {
                window.performanceTrackerInstance = performanceTracker;
            } else {
                global.performanceTrackerInstance = performanceTracker;
            }

            // Enable/disable based on URL flag (only in browser)
            if (
        ...
        */
        ...
        if (tracker) {
            tracker.enterBlock(); // or startRun, exitBlock, etc.
        }
        /*
        ===========================================================================
