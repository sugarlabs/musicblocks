    ...
    flow(args, logo, turtle, blk) {
        ...
        if (logo.inNoteBlock[turtle].length > 0) {
            ...
            if (logo.justCounting[turtle].length === 0) {
                logo._playbackPush(turtle, [logo.previousTurtleTime[turtle], 'hollowline']);
            }
        }
...
class FillBlock extends FlowClampBlock {
    ...
    flow(args, logo, turtle, blk) {
        ...
        if (logo.inNoteBlock[turtle].length > 0) {
            ...
            if (logo.justCounting[turtle].length === 0) {
                logo._playbackPush(turtle, [logo.previousTurtleTime[turtle], 'fill']);
            }
        }
...
class PenUpBlock extends FlowBlock {
    ...
    flow(args, logo, turtle, blk) {
        if (logo.inNoteBlock[turtle].length > 0) {
            ...
            if (logo.justCounting[turtle].length === 0) {
                logo._playbackPush(turtle, [logo.previousTurtleTime[turtle], 'penup']);
            }
        }
    }
}
...
class PenDownBlock extends FlowBlock {
    ...
    flow(args, logo, turtle, blk) {
        if (logo.inNoteBlock[turtle].length > 0) {
            ...
            if (logo.justCounting[turtle].length === 0) {
                logo._playbackPush(turtle, [logo.previousTurtleTime[turtle], 'pendown']);
            }
        }
    }
}
...
class SetPenSizeBlock extends FlowBlock {
    ...
    flow(args, logo, turtle, blk) {
        ...
        if (typeof(args[0]) === 'string') {
            ...
            if (logo.justCounting[turtle].length === 0) {
                logo._playbackPush(turtle, [logo.previousTurtleTime[turtle], 'setpensize', args[0]]);
            }
        }
    }
}
...
class SetTranslucencyBlock extends FlowBlock {
    ...
    flow(args, logo, turtle, blk) {
        ...
        if (typeof(args[0]) === 'string') {
            ...
            if (logo.justCounting[turtle].length === 0) {
                logo._playbackPush(turtle, [logo.previousTurtleTime[turtle], 'settranslucency', arg]);
            }
        }
    }
}
...
class SetHueBlock extends FlowBlock {
    ...
    flow(args, logo, turtle, blk) {
        ...
        if (typeof(args[0]) === 'string') {
            ...
            logo.turtles.turtleList[turtle].doSetHue(args[0]);
            if (logo.justCounting[turtle].length === 0) {
                logo._playbackPush(turtle, [logo.previousTurtleTime[turtle], 'sethue', args[0]]);
            }
        }
    }
}
...
class SetShadeBlock extends FlowBlock {
    ...
    flow(args, logo, turtle, blk) {
        ...
        if (typeof(args[0]) === 'string') {
            ...
            if (logo.justCounting[turtle].length === 0) {
                logo._playbackPush(turtle, [logo.previousTurtleTime[turtle], 'setshade', args[0]]);
            }
        }
    }
}
...
class SetGreyBlock extends FlowBlock {
    ...
    flow(args, logo, turtle, blk) {
        ...
        if (typeof(args[0]) === 'string') {
            ...
            if (logo.justCounting[turtle].length === 0) {
                logo._playbackPush(turtle, [logo.previousTurtleTime[turtle], 'setgrey', args[0]]);
            }
        }
    }
}
...
class SetColorBlock extends FlowBlock {
    ...
    flow(args, logo, turtle, blk) {
        ...
        if (typeof(args[0]) === 'string') {
            ...
            if (logo.justCounting[turtle].length === 0) {
                logo._playbackPush(turtle, [logo.previousTurtleTime[turtle], 'setcolor', args[0]]);
            }
        }
    }
}
