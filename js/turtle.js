...
function Turtles () {
    ...
    this.makeBackground = function (setCollapsed) {
	    ...
	    that._locked = true;
            ...
            img.onload = function () {
                ...
                that._expandedBoundary.y = 55 + this.LEADING;
                that._borderContainer.addChild(that._expandedBoundary);
                __makeBoundary2();
            };

            var dx = that.w - 5;
            var dy = that.h - 55 - this.LEADING;
        ...
        function __makeBoundary2() {
            ...
            img.onload = function () {
                ...
                that._collapsedBoundary.y = 55 + this.LEADING;
        ...
        function __makeExpandButton() {
            ...
            img.onload = function () {
                ...
                that._expandButton.y = 70 + this.LEADING + 6;
        ...
        function __makeCollapseButton() {
            ...
            img.onload = function () {
                ...
                that._collapseButton.y = 70 + this.LEADING + 6;
                that.refreshCanvas();
        ...
        function __makeClearButton() {
            ...
            img.onload = function () {
                ...
                bitmap.visible = true;
                that._clearButton.x = that.w - 5 - 2 * 55;
                that._clearButton.y = 70 + this.LEADING + 6;
        ...
        function __makeGridButton() {
            ...
            img.onload = function () {
                ...
                bitmap.visible = true;
                that._gridButton.x = that.w - 10 - 3 * 55;
                that._gridButton.y = 70 + this.LEADING + 6;
                that._gridButton.visible = true;
    ...
    this.collapse = function () {
        ...
        this.stage.y = 55 + this.LEADING + 6;
        this.isShrunk = true;
