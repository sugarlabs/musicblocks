...
describe("setupVolumeActions", () => {
    ...
    describe("doCrescendo", () => {
        it("should setup crescendo with specified value", () => {
        ...
        it("should setup decrescendo with negative value", () => {
            Singer.VolumeActions.doCrescendo("decrescendo", 10, 0, 1);
        ...
        it("should execute listener and end crescendo correctly", () => {
            Singer.VolumeActions.doCrescendo("crescendo", 10, 0, 1);
            ...
            expect(targetTurtle.singer.crescendoDelta).toHaveLength(0);
            expect(crescendoEndSpy).toHaveBeenCalledWith(0, 10);
        });
        
        it("should not call notationEndCrescendo if justCounting is not empty", () => {
