...
function createHelpContent() {
	...
	'pitchnumber': [_('The Pitch Number block will play a pitch associated by its number, e.g, 1 for C, 7 for G.'), 'documentation', 'pitch-number-block.svg'],
        ...
        'dispatch': [_('The Broadcase block is used to trigger an event.'), 'documentation', 'broadcast-block.svg'],
        ...
        'drift': [_('The No clock block decouples the notes from the master clock.'), 'documentation', 'status.svg'],
	...
	'bpmfactor': [_('The Beats per minute block returns the current beats per minute.'), 'documentation', 'status.svg'],
        ...
        // pitch palette
        'accidental': [_('The Accidental block is used to create sharps and flats'), 'documentation', 'status.svg'],
        'settransposition': [_('The Semi-tone transposition block will shift the pitches contained inside Note blocks up (or down) by half steps.') + ' ' + _('In the example shown above, sol is shifted up to sol#.'), 'documentation', 'status.svg'],
        ...
        'invert1': [_('The Invert block rotates any contained notes around a target note.'), 'documentation', 'invert-block.svg'],
        'deltapitch': [_('The Change in pitch block is the difference (in half steps) between the current pitch being played and the previous pitch played.'), 'documentation', 'status.svg'],
	...
	//.TRANS: 'ni', 'dha', 'pa', 'ma', 'ga', 're', 'sa' are East Indian note names.
        ...
        'accidentalname': [_('The Accidental selector block is used to choose between double-sharp, sharp, natural, flat, and double-flat.'), 'documentation', 'status.svg'],
        ...
        // Intervals palette
        'movable': [_('When Moveable do is false, the solfege note names are always tied to specific pitches,') + ' ' + _('e.g. "do" is always "C-natural"); when Moveable do is true, the solfege note names are assigned to scale degrees ("do" is always the first degree of the major scale).'), 'documentation', 'status.svg'],
        ...
        // Tone palette
        'voicename': [_('The Set timbre block selects a voice for the synthesizer,') + ' ' + _('e.g., guitar, piano, violin, or cello.'), 'documentation', 'set-timbre-block.svg'],
        'chorus': [_('The Chorus block adds a chorus effect.'), 'documentation', 'status.svg'],
        'phaser': [_('The Phaser block adds a sweeping sound.'), 'documentation', 'status.svg'],
        'dis': [_('The Distortion block adds distortion to the pitch.'), 'documentation', 'status.svg'],
        'tremolo': [_('The Tremolo block adds a wavering effect.'), 'documentation', 'status.svg'],
