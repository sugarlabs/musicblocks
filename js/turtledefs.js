...
function createHelpContent() {
	...
	//.TRANS: 'ni', 'dha', 'pa', 'ma', 'ga', 're', 'sa' are East Indian note names.
        ...
        'setHeapEntry': [_('The <em>Setheapentry</em> block will set a value in he heap at the specified location.'), 'documentation', 'status.svg'],
        'indexHeap': [_('The <em>Indexheap</em> block will return a value in the heap at a specified location.'), 'documentation', 'status.svg'],
        'reverseHeap': [_('The <em>Reverseheap</em> block will reverse the order of the heap.'), 'documentation', 'status.svg'],
        'loadHeap': [_('The <em>Loadheap</em> block will load the heap from a file.'), 'documentation', 'status.svg'],
        'saveHeap': [_('The <em>Saveheap</em> block will save the heap to a file.'), 'documentation', 'status.svg'],
        'emptyHeap': [_('The <em>Emptyheap</em> block will empty the heap.'), 'documentation', 'status.svg'],
        'heapEmpty': [_('The <em>Heap empty?</em> block will return true if the heap is emptry.'), 'documentation', 'status.svg'],
        'heapLength': [_('The <em>Heap length</em> block will return the length of the heap.'), 'documentation', 'status.svg'],
        'showHeap': [_('The <em>Show heap</em> block will display the contents of the heap at the top of the screen.'), 'documentation', 'status.svg'],
        'saveHeapToApp': [_('The <em>Save heap to app</em> block will save the heap to a web page.'), 'documentation', 'status.svg'],
        'loadHeapFromApp': [_('The <em>Load heap from app</em> block will load the heap from a web page.'), 'documentation', 'status.svg'],
        // Extras palette
        'comment': [_('The <em>Comment</em> block will print a comment at the top of the screen when the program is running in slow mode.'), 'documentation', 'status.svg'],
        'wait': [_('The <em>Wait</em> block will pause the program for a specified number of seconds.'), 'documentation', 'status.svg'],
        ...
        'hideblocks': [_('The <em>Hide blocks</em> block will hide the blocks.'), 'documentation', 'status.svg'],
        'showblocks': [_('The <em>Show blocks</em> block will show the blocks.'), 'documentation', 'status.svg'],
        'nobackground': [_('The <em>No background</em> block will eliminate the background from the saved SVG output.'), 'documentation', 'status.svg'],
        'makeblock': [_('The <em>Make block</em> block will create a new block.'), 'documentation', 'status.svg'],
        'dockblock': [_('The <em>Dock block</em> block will connection two blocks.'), 'documentation', 'status.svg'],
        'runblock': [_('The <em>Run block</em> block will run a block.'), 'documentation', 'status.svg'],
        'moveblock': [_('The <em>Move block</em> block will move a block.'), 'documentation', 'status.svg'],
