...
function createHelpContent() {
    if (beginnerMode) {
        HELPCONTENT = [
            ...
            [_('Keyboard shortcuts'), _('You can type "d" to create a "do" block, "r" to create a "re" block, etc.'), 'data:image/svg+xml;base64,' + window.btoa(unescape(encodeURIComponent(SHORTCUTSBUTTON)))],
