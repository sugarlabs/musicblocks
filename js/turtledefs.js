...
BUILTINPALETTES = ['rhythm', 'pitch', 'tone', 'drum', 'flow', 'action', 'boxes', 'widgets', 'turtle', 'pen', 'number', 'boolean', 'media', 'sensors', 'heap', 'extras'];

const BUILTINPALETTESFORL23N = [_('rhythm'), _('pitch'), _('tone'), _('drum'), _('flow'), _('action'), _('boxes'), _('widgets'), _('turtle'), _('pen'), _('number'), _('boolean'), _('media'), _('sensors'), _('heap'), _('extras')];
