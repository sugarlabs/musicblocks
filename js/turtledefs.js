...
BUILTINPALETTES = ['rhythm', 'pitch', 'tone', 'flow', 'actions', 'boxes', 'matrix', 'turtle', 'pen', 'number', 'boolean', 'media', 'sensors', 'heap', 'extras'];

const BUILTINPALETTESFORL23N = [_('rhythm'), _('pitch'), _('tone'), _('flow'), _('actions'), _('boxes'), _('matrix'), _('turtle'), _('pen'), _('number'), _('boolean'), _('media'), _('sensors'), _('heap'), _('extras')];
