...
function createHelpContent() {
	...
	'meterwidget': [_('The Meter block opens a tool to select strong beats for the meter.'), 'documentation', 'meterwidget-block.svg', 'meterwidget'],
        ...
        'storebox2': [_('The Store in Box 2 block is used to store a value in Box 2.'), 'documentation', 'box-2-block.svg', 'box2help'],
        'box2': [_('The Box 2 block returns the value stored in Box 2.'), 'documentation', 'box-2-block.svg', 'box2help'],
        ...
        'toppos': [_('The Top block returns the position of the top of the canvas.') + ' ' + _('In this example, the mouse moves upward until it reaches the top edge of the canvas; then it reappears at the bottom of the canvas.'), 'documentation', 'bottom-top-block.svg', 'bottomposhelp'],
        'bottompos': [_('The Bottom block returns the position of the bottom of the canvas.') + ' ' + _('In this example, the mouse moves upward until it reaches the top edge of the canvas; then it reappears at the bottom of the canvas.'), 'documentation', 'bottom-top-block.svg', 'bottomposhelp'],
        ...
        'drift': [_('The No clock block decouples the notes from the master clock.'), 'documentation', 'no-clock.svg'],
        ...
        // Boxes palette
        'storein': [_('The Store in block will store a value in a box.'), 'documentation', 'storein-block.svg'],
        'storein2': [_('The Store in block will store a value in a box.'), 'documentation', 'storein-block.svg'],
        ...
        'setHeapEntry': [_('The Set-heap entry block sets a value in he heap at the specified location.'), 'documentation', 'status.svg'],
        'indexHeap': [_('The Index-heap block returns a value in the heap at a specified location.'), 'documentation', 'status.svg'],
        'reverseHeap': [_('The Reverse-heap block reverses the order of the heap.'), 'documentation', 'status.svg'],
        'loadHeap': [_('The Load-heap block loads the heap from a file.'), 'documentation', 'status.svg'],
        'saveHeap': [_('The Save-heap block saves the heap to a file.'), 'documentation', 'status.svg'],
        'emptyHeap': [_('The Empty-heap block empties the heap.'), 'documentation', 'status.svg'],
        'heapEmpty': [_('The Heap-empty? block returns true if the heap is empty.'), 'documentation', 'status.svg'],
        ...
        'turtleelapsednotes': [_('The Mouse elapse notes block returns the number of notes played by the specified mouse.'), 'documentation', 'status.svg'],
