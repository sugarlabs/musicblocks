...
function createHelpContent() {
    ...
    BLOCKHELP = {
        // Rhythm palette
        'newnote': [_('The <em>Note</em> block is a container for one or more <em>Pitch</em> blocks. The <em>Note</em> block specifies the duration (note value) of its contents.'), 'documentation', 'note-value-block.svg'],
        'playdrum': [_('You can use multiple <em>Drum</em> blocks within a <em>Note</em> block.'), 'documentation', 'drum-block.svg'],
        'rest2': [_('A rest of the specified note value duration can be constructed using a <em>Silence</em> block.'), 'documentation', 'silence-block.svg'],
        'mynotevalue': [_('The <em>Note value</em> block is the value of the duration of the note currently being played.'), 'documentation', 'on-every-beat-do-block.svg'],
        // Meter palette
        'meter': [_('The beat of the music is determined by the <em>Meter</em> block (by default, 4 1/4 notes per measure).'), 'documentation', 'meter-block.svg'],
        'setmasterbpm2': [_('The <em>Beats per minute</em> block sets the number of 1/4 notes per minute.'), 'documentation', 'master-beats-per-minute-block.svg'],
        'everybeatdo': [_('The <em>On-every-beat</em> block let you specify actions to take on every beat.'), 'documentation', 'on-every-beat-do-block.svg'],
        'beatvalue': [_('The <em>Beat count</em> block is the number of the current beat, e.g., 1, 2, 3, or 4.\n In the figure, it is used to take an action on the first beat of each measure.'), 'documentation', 'on-every-beat-do.svg'],
        'elapsednotes2': [_('The <em>Notes played</em> block is the number of notes that have been played. (By default, it counts quarter notes.)'), 'documentation', 'on-every-beat-do.svg'],
        // Pitch palette
        'pitch': [_('The <em>Pitch</em> block specifies the pitch name and octave of a note that together determine the frequency of the note.'), 'documentation', 'note-value-block.svg'],
        'solfege': [_('Pitch can be specified in terms of <em>do re mi fa sol la ti<em>.'), 'documentation', 'note-value-block.svg'],
        'notename': [_('Pitch can be specified in terms of <em>C D E F G A B</em>.'), 'documentation', 'note-name-block.svg'],
        'steppitch': [_('The <em>Scaler Step</em> block (in combination with a <em>Number</em> block) will play the next pitch in a scale, e.g., if the last note played was <em>sol</em>, <em>Scalar Step 1</em> will play <em>la</em>.'), 'documentation', 'set-key-block.svg'],
        'hertz': [_('The <em>Hertz</em> block (in combination with a <em>Number</em> block) will play a sound at the specified frequency.'), 'documentation', 'hertz-block.svg'],
        'setscalartransposition': [_('The <em>Scalar transposition</em> block will shift the pitches contained inside <em>Note</em> blocks up (or down) the scale. In the example shown above, <em>sol</em> is shifted up to <em>la</em>.'), 'documentation', 'scalar-transpose-block.svg'],
        'pitchinhertz': [_('The <em>Pitch in Hertz</em> block is the value in Hertz of the pitch of the note currently being played.'), 'documentation', 'status-block.svg'],
        'mypitch': [_('The <em>Pitch number</em> block is the value of the pitch of the note currently being played.'), 'documentation', 'on-every-beat-do-block.svg'],
        // Intervals palette
        'setkey2': [_('The <em>Set key</em> block is used to set the key and mode, e.g., <em>C Major</em>'), 'documentation', 'set-key-block.svg'],
        'modelength': [_('The <em>Mode length</em> block is the number of notes in the current scale. Most <em>Western</em> scales have 7 notes.'), 'documentation', 'set-key-block.svg'],
        'interval': [_('The <em>Scalar interval</em> block calculates a relative interval based on the current mode, skipping all notes outside of the mode. In the figure, we add <em>la</em> to <em>sol</em>.'), 'documentation', 'scalar-interval-block.svg'],
        'settemperament': [_('The <em>Set temperament</em> block is used to choose the tuning system used by Music Blocks.'), 'documentation', 'set-temperament-block.svg'],
        // Tone palette
        'settimbre': [_('The <em>Set timbre</em> block selects a voice for the synthesizer, e.g., guitar, piano, violin, or cello.'), 'documentation', 'start-block.svg'],
        'newstaccato': [_('The <em>Staccato</em> block shortens the length of the actual note while maintaining the specified rhythmic value of the notes.'), 'documentation', 'staccato-block.svg'],
        'newslur': [_('The <em>Slur</em> block lengthens the sustain of notes while maintaining the specified rhythmic value of the notes.'), 'documentation', 'slur-block.svg'],
        'vibrato': [_('The <em>Vibrato</em> block adds a rapid, slight variation in pitch.'), 'documentation', 'vibrato-block.svg'],
        'neighbor2': [_('The <em>Neighbor</em> block rapidly switches between neighboring pitches.'), 'documentation', 'neighbor-block.svg'],
        // Volume palette
        'crescendo': [_('The <em>Crescendo</em> block will increase the volume of the contained notes by a specified amount for every note played. For example, if you have 7 notes in sequence contained in a <em>Crescendo</em> block with a value of 5, the final note will be at 35% more than the starting volume.'), 'documentation', 'crescendo-block.svg'],
        'decrescendo': [_('The <em>Decrescendo</em> block will decrease the volume of the contained notes by a specified amount for every note played. For example, if you have 7 notes in sequence contained in a <em>Decrescendo</em> block with a value of 5, the final note will be at 35% less than the starting volume.'), 'documentation', 'decrescendo-block.svg'],
        'setsynthvolume': [_('The <em>Set synth volume</em> block will change the volume of a particular synth, e.g., guitar, violin, snare drum, etc. The default volume is 50; the range is 0 (silence) to 100 (full volume).'), 'documentation', 'start-block.svg'],
        // Drum palette
        // 'playdrum' is described on the Rhythm palette.
        'setdrum': [_('The <em>Set drum</em> block will select a drum sound to replace the pitch of any contained notes. In the example above, a <em>kick drum</em> sound will be played instead of <em>sol</em>.'), 'documentation', 'rhythm-ruler-block.svg'],
        // Widgets palette
        'status': [_('The <em>Status</em> block opens a tool for inspecting the status of Music Blocks as it is running.'), 'documentation', 'status-block.svg'],
        'matrix': [_('The <em>Pitch-time Matrix</em> block opens a tool to create musical phrases.'), 'documentation', 'pitch-time-matrix-block.svg'],
        'rhythmruler2': [_('The <em>Rhythm Maker</em> block opens a tool to create drum machines.'), 'documentation', 'rhythm-ruler-block.svg'],
        'pitchslider': [_('The <em>Pitch-slider<em> block opens a tool to generate arbitray pitches.'), 'documentation', 'pitch-slider-block.svg'],
        'rhythm2': [_('The <em>Rhythm</em> block is used to generate rhythm patterns.'), 'documentation', 'rhythm-ruler-block.svg'],
        'stuplet': [_('<em>Tuplets</em> are a collection of notes that get scaled to a specific duration. Using tuplets makes it easy to create groups of notes that are not based on a power of 2.'), 'documentation', 'pitch-time-matrix-block.svg'],
        'musickeyboard': [_('The <em>Music keyboard</em> block opens a piano keyboard that can be used to create notes.'), 'documentation', 'music-keyboard-block.svg'],
        'tempo': [_('The <em>Tempo</em> block opens a metronome to visualize the beat.'), 'documentation', 'tempo-block.svg'],
        'modewidget': [_('The <em>Custom mode</em> block opens a tool to explore musical mode (the spacing of the notes in a scale).'), 'documentation', 'custom-mode-block.svg'],
        // Flow palette
        'repeat': [_('The <em>Repeat</em> block will repeat the contained blocks. In this example, the note will be played 4 times.'), 'documentation', 'repeat-block.svg'],
        'forever': [_('The <em>Forever</em> block will repeat the contained blocks forever. In this example, a simple drum machine, a kick drum will play 1/4 notes forever.'), 'documentation', 'forever-block.svg'],
        'if':  [_('Conditionals lets your program take different actions depending on the <em>condition</em>. In this example, <em>if</em> the mouse button is pressed, a snare drum will play. Otherwise (<em>else</em>) a kick drum will play.'), 'documentation', 'conditional-block.svg'],
        'ifthenelse': [_('Conditionals lets your program take different actions depending on the <em>condition</em>. In this example, <em>if</em> the mouse button is pressed, a snare drum will play. Otherwise (<em>else</em>) a kick drum will play.'), 'documentation', 'conditional-block.svg'],
        'backward': [_('The <em>Backward</em> block runs code in reverse order (Musical retrograde).'), 'documentation', 'box-1-block.svg'],
        // Action palette
        'action': [_('The <em>Action</em> block is used to group together blocks so that they can be used more than once. It is often used for storing a phrase of music that is repeated.'), 'documentation', 'action-block.svg'],
        'start': [_('Each <em>Start</em> block is a separate voice. All of the <em>Start</em> blocks run at the same time when the <em>Play</em> button is pressed.'), 'documentation', 'repeat-block.svg'],
        'listen': [_('The <em>Listen</em> block is used to listen for an event such as a mouse click. When the event happens, an <em>action</em> is taken.'), 'documentation', 'broadcast-block.svg'],
        'dispatch': [_('The <em>Dispatch</em> block is used to trigger an event.'), 'documentation', 'broadcast.svg'],
        'do': [_('The <em>Do</em> block is used to initiate an action.') + ' ' + _('In the example, it is used with the <em>One of</em> block to choose a random phase.'), 'documentation', 'do-block.svg'],
        // Boxes palette
        'storebox1': [_('The <em>Store in Box 1</em> block is used to store a value in <em>Box 1</em>.'), 'documentation', 'box-1-block.svg'],
        'box1': [_('The <em>Box 1</em> block returns the value stored in <em>Box 1</em>.'), 'documentation', 'box-1-block.svg'],
        'storebox2': [_('The <em>Store in Box 2</em> block is used to store a value in <em>Box 2</em>.'), 'documentation', 'box-2-block.svg'],
        'box2': [_('The <em>Box 2</em> block returns the value stored in <em>Box 2</em>.'), 'documentation', 'box-2-block.svg'],
        'increment': [_('The <em>Add-to</em> block is used to add to the value stored in a box. It can also be used with other blocks, such as <em>Color</em>, <em>Pen-size</em>. etc.'), 'documentation', 'box-2-block.svg'],
        'incrementOne': [_('The <em>Add-1-to<em> block adds one to the value stored in a box.'), 'documentation', 'box-1-block.svg'],
        // Number palette
        ...
        'divide': [_('The <em>Divide</em> block is used to divide.'), 'documentation', 'note-value-block.svg'],
        // Boolean palette
        'greater': [_('The <em>Greater-than</em> block returns <em>True</em> if the top number is greater than the bottom number.'), 'documentation', 'box-2-block.svg'],
        'less': [_('The <em>Less-than</em> block returns <em>True</em> if the top number is less than the bottom number.'), 'documentation', 'box-2-block.svg'],
        'equal': [_('The <em>Equal</em> block returns <em>True</em> if the two numbers are equal.'), 'documentation', 'box-1-block.svg'],
        // Mouse palette
        'forward': [_('The <em>Forward</em> block moves the mouse forward.'), 'documentation', 'forward-block.svg'],
        'back': [_('The <em>Back</em> block moves the mouse backward.'), 'documentation', 'forward-block.svg'],
        'left': [_('The <em>Left</em> block turns the mouse to the left.'), 'documentation', 'forward-block.svg'],
        'right': [_('The <em>Right</em> block turns the mouse to the right.'), 'documentation', 'forward-block.svg'],
        ...
        'penup': [_('The <em>Pen-up</em> block raises the pen so that it does not draw.'), 'documentation', 'mouse-button-block.svg'],
        'pendown': [_('The <em>Pen-down</em> block lowers the pen so that it draws.'), 'documentation', 'mouse-button-block.svg'],
        'color': [_('The <em>Color</em> block returns the current pen color.'), 'documentation', 'set-color-block.svg'],
        'setcolor': [_('The <em>Set-color</em> block changes the pen color.'), 'documentation', 'set-color-block.svg'],
        // Media palette
        'print': [_('The <em>Print</em> block displays text at the top of the screen.'), 'documentation', 'print-block.svg'],
        'text': [_('The <em>Text</em> block holds a text string.'), 'documentation', 'show-block.svg'],
        'media': [_('The <em>Media</em> block is used to import an image.'), 'documentation', 'avatar-block.svg'],
        'show': [_('The <em>Show</em> block is used to display text or images on the canvas.'), 'documentation', 'show-block.svg'],
        'turtleshell': [_('The <em>Shell</em> block is used to change the appearance of the mouse.'), 'documentation', 'avatar-block.svg'],
        'speak': [_('The <em>Speak</em> block outputs to the text-to-speech synthesizer'), 'documentation', 'speak-block.svg'],
	...
	//.TRANS: 'ni', 'dha', 'pa', 'ma', 'ga', 're', 'sa' are East Indian note names.
        ...
        'deleteblock': [_('The <em>Delete block</em> block removes a block.'), 'documentation', 'status.svg'],
	...
	'getblue': [_('The <em>Get blue</em> block returns the blue component of the pixel under the mouse.'), 'documentation', 'status.svg'],
        ...
        // Ensemble palette
        'newturtle': [_('The <em>New mouse</em> block will create a new mouse.'), 'documentation', 'status.svg'],
        'foundturtle': [_('The <em>Found mouse</em> block will return true if the specified mouse can be found.'), 'documentation', 'status.svg'],
        'turtlesync': [_('The <em>Mouse sync</em> block aligns the beat count between mice.'), 'documentation', 'status.svg'],
        'turtlenote2': [_('The <em>Mouse note</em> block returns the current note value being played by the specified mouse.'), 'documentation', 'status.svg'],
        'turtlepitch': [_('The <em>Mouse pitch</em> block returns the current pitch number being played by the specified mouse.'), 'documentation', 'status.svg'],
        'turtleelapsenotes': [_('The <em>Mouse elapse notes</em> block returns the number of notes played by the specified mouse.'), 'documentation', 'status.svg'],
        'xturtle': [_('The <em>X mouse</em> block returns the X position of the specified mouse.'), 'documentation', 'status.svg'],
        'yturtle': [_('The <em>Y mouse</em> block returns the Y position of the specified mouse.'), 'documentation', 'status.svg'],
        'setturtle': [_('The <em>Set mouse</em> block sends a stack of blocks to be run by the specified mouse.'), 'documentation', 'status.svg'],
        'turtleheading': [_('The <em>Mouse heading</em> block returns the heading of the specified mouse.'), 'documentation', 'status.svg'],
        'turtlecolor': [_('The <em>Mouse color</em> block returns the pen color of the specified mouse.'), 'documentation', 'status.svg'],
        'startturtle': [_('The <em>Start mouse</em> block starts the specified mouse.'), 'documentation', 'status.svg'],
        'stopturtle': [_('The <em>Stop mouse</em> block stops the specified mouse.'), 'documentation', 'status.svg'],
    }
};
