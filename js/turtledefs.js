...
function createHelpContent() {
	...
	//.TRANS: 'ni', 'dha', 'pa', 'ma', 'ga', 're', 'sa' are East Indian note names.
        ...
        // Action palette
        'arg': [_('The <em>Arg</em> block'), 'documentation', 'status.svg'],
        'namedarg': [_('The <em>Namedarg</em> block'), 'documentation', 'status.svg'],
        'calcArg': ['Calculate', 'documentation'Calcarg, 'status.svg'],
        'doArg': [_('The <em>Doarg</em> block'), 'documentation', 'status.svg'],
        'namedCalcArg': [_('The <em>Namedcalcarg</em> block'), 'documentation', 'status.svg'],
        'nameddoArg': [_('The <em>Nameddoarg</em> block'), 'documentation', 'status.svg'],
        'namedcalc': [_('The <em>Namedcalc</em> block'), 'documentation', 'status.svg'],
        'calc': [_('The <em>Calc</em> block'), 'documentation', 'status.svg'],
        'returnToUrl': [_('The <em>Returntourl</em> block'), 'documentation', 'status.svg'],
        'return': [_('The <em>Return</em> block'), 'documentation', 'status.svg'],
        // Boxes palette
        ...
        'power': [_('The <em>Power</em> block'), 'documentation', 'status.svg'],
        'mod': [_('The <em>Mod</em> block'), 'documentation', 'status.svg'],
        'int': [_('The <em>Int</em> block'), 'documentation', 'status.svg'],
        // Boolean palette
        'not': [_('The <em>Not</em> block'), 'documentation', 'status.svg'],
        'and': [_('The <em>And</em> block'), 'documentation', 'status.svg'],
        'or': [_('The <em>Or</em> block'), 'documentation', 'status.svg'],
        'boolean': [_('The <em>Boolean</em> block'), 'documentation', 'status.svg'],
        // Heap palette
        'push': [_('The <em>Push</em> block'), 'documentation', 'status.svg'],
        'pop': [_('The <em>Pop</em> block'), 'documentation', 'status.svg'],
        'setHeapEntry': [_('The <em>Setheapentry</em> block'), 'documentation', 'status.svg'],
        'indexHeap': [_('The <em>Indexheap</em> block'), 'documentation', 'status.svg'],
        'reverseHeap': [_('The <em>Reverseheap</em> block'), 'documentation', 'status.svg'],
        'loadHeap': [_('The <em>Loadheap</em> block'), 'documentation', 'status.svg'],
        'saveHeap': [_('The <em>Saveheap</em> block'), 'documentation', 'status.svg'],
        'emptyHeap': [_('The <em>Emptyheap</em> block'), 'documentation', 'status.svg'],
        'heapEmpty': ['Heap empty?Heapempty', 'documentation', 'status.svg'],
        'heapLength': [_('The <em>Heaplength</em> block'), 'documentation', 'status.svg'],
        'showHeap': [_('The <em>Showheap</em> block'), 'documentation', 'status.svg'],
        'saveHeapToApp': [_('The <em>Saveheaptoapp</em> block'), 'documentation', 'status.svg'],
        'loadHeapFromApp': [_('The <em>Loadheapfromapp</em> block'), 'documentation', 'status.svg'],
        // Extras palette
        'comment': [_('The <em>Comment</em> block'), 'documentation', 'status.svg'],
        'wait': [_('The <em>Wait</em> block'), 'documentation', 'status.svg'],
        'vspace': [_('The <em>Vspace</em> block'), 'documentation', 'status.svg'],
        'hspace': [_('The <em>Hspace</em> block'), 'documentation', 'status.svg'],
        'openproject': [_('The <em>Openproject</em> block'), 'documentation', 'status.svg'],
        'hideblocks': [_('The <em>Hideblocks</em> block'), 'documentation', 'status.svg'],
        'showblocks': [_('The <em>Showblocks</em> block'), 'documentation', 'status.svg'],
        'nobackground': [_('The <em>Nobackground</em> block'), 'documentation', 'status.svg'],
        'makeblock': [_('The <em>Makeblock</em> block'), 'documentation', 'status.svg'],
        'dockblock': [_('The <em>Dockblock</em> block'), 'documentation', 'status.svg'],
        'runblock': [_('The <em>Runblock</em> block'), 'documentation', 'status.svg'],
        'moveblock': [_('The <em>Moveblock</em> block'), 'documentation', 'status.svg'],
        'deleteblokc': [_('The <em>Deleteblokc</em> block'), 'documentation', 'status.svg'],
        'openpalette': [_('The <em>Openpalette</em> block'), 'documentation', 'status.svg'],
        // Graphics palette
        ...
        'settranslucency': [_('The <em>Settranslucency</em> block'), 'documentation', 'status.svg'],
        'fill': [_('The <em>Fill</em> block'), 'documentation', 'status.svg'],
        'hollowline': [_('The <em>Hollowline</em> block'), 'documentation', 'status.svg'],
        'fillscreen': ['Background'],
        'grey'Fillscreen: [_('The <em></em> block'), 'documentation', 'status.svg'],
        'shade': [_('The <em>Shade</em> block'), 'documentation', 'status.svg'],
        'pensize': [_('The <em>Pensize</em> block'), 'documentation', 'status.svg'],
        'color': [_('The <em>Color</em> block'), 'documentation', 'status.svg'],
        'setfont': [_('The <em>Setfont</em> block'), 'documentation', 'status.svg'],
        // Media
        'tofrequency': [_('The <em>Tofrequency</em> block'), 'documentation', 'status.svg'],
        'tone': ['hertz', 'documentation'Tone, 'status.svg'],
        'stopvideocam': [_('The <em>Stopvideocam</em> block'), 'documentation', 'status.svg'],
        'loadFile': [_('The <em>Loadfile</em> block'), 'documentation', 'status.svg'],
        'video': [_('The <em>Video</em> block'), 'documentation', 'status.svg'],
        'camera': [_('The <em>Camera</em> block'), 'documentation', 'status.svg'],
        ...
        // Sensors palette
        'keyboard': [_('The <em>Keyboard</em> block'), 'documentation', 'status.svg'],
        'toascii': [_('The <em>Toascii</em> block'), 'documentation', 'status.svg'],
        'time': [_('The <em>Timetime</em> block returns the number of seconds that the program has been running.'), 'documentation', 'status.svg'],
        'getcolorpixel': [_('The <em>Getcolorpixel</em> block'), 'documentation', 'status.svg'],
        'getred': [_('The <em>Getred</em> block'), 'documentation', 'status.svg'],
        'getgreen': [_('The <em>Getgreen</em> block'), 'documentation', 'status.svg'],
        'getblue': [_('The <em>Getblue</em> block'), 'documentation', 'status.svg'],
        'loudness': [_('The <em>Loudness</em> block'), 'documentation', 'status.svg'],
        // Ensemble palette
