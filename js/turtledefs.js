...
function getMainToolbarButtonNames(name) {
    return (['popdown-palette', 'run', 'step', 'step-music', 'stop-turtle', 'clear', 'palette', 'hide-blocks', 'collapse-blocks', 'go-home', 'help', 'sugarizer-stop'].indexOf(name) > -1);
};
...
function createHelpContent() {
    HELPCONTENT = [
        ...
        //.TRANS: Please add commas to list: Rhythm, Pitch, Tone, Turtle, and more.
	//.TRANS: the buttons used to open various palettes of blocks
        [_('Palette buttons'), _('This toolbar contains the palette buttons, including Rhythm Pitch Tone Turtle and more.') + ' ' + _('Click to show the palettes of blocks and drag blocks from the palettes onto the canvas to use them.'), 'images/icons.svg'],
