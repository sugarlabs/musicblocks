...
SEARCHINDEX = {
    ...
    "fifth": "pitch",
    "current pitch": "pitch",
    "pitch converter": "pitch",
    "set key": "intervals",
    "mode length": "intervals",
    "movable Do": "intervals",
    "scalar interval (+/–)": "intervals",
    "set temperament": "intervals",
    "set instrument": "tone",
    "vibrato": "tone",
    "chorus": "tone",
    "tremolo": "tone",
    ...
    "set panning": "volume",
    "set synth volume": "volume",
    "set drum volume": "volume",
    "drum": "drum",
    "sound effect": "drum",
    "set drum": "drum",
    "status": "widgets",
    "phrase maker": "widgets",
    "C major scale": "widgets",
    "G major scale": "widgets",
    "rhythm maker": "widgets",
    "pitch staircase": "widgets",
    "music keyboard": "widgets",
    "pitch slider": "widgets",
    "tempo": "widgets",
    "custom mode": "widgets",
    "simple tuplet": "widgets",
    "repeat": "flow",
    "forever": "flow",
    "if": "flow",
    "backward": "flow",
    ...
    "cursor x": "sensors",
    "cursor y": "sensors",
    "mouse button": "sensors",
    "click": "sensors",
    "loudness": "sensors",
    "time": "sensors",
    "set name": "ensemble",
    "set mouse color": "ensemble",
    "mouse name": "ensemble",
};
