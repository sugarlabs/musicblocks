...
function blockIsMacro (blkname) {
    ...
    const BLOCKISMACRO = ['accidental', 'action', 'articulation', 'augmented1', 'augmented2', 'augmented3', 'augmented4', 'augmented5', 'augmented6', 'augmented7', 'augmented8', 'backward', 'bottle', 'box1', 'box2', 'bubbles', 'cat', 'chine', 'chordI', 'chordIV', 'chordV', 'clang', 'clap', 'cowbell', 'crash', 'crescendo', 'cricket', 'cup', 'custompitch', 'darbuka', 'decrescendo', 'definemode', 'diminished2', 'diminished3', 'diminished4', 'diminished5', 'diminished6', 'diminished7', 'diminished8', 'dog', 'downsixthinterval', 'downthirdinterval', 'downmajor3', 'downmajor6', 'downminor3', 'downminor6', 'downsixth', 'downthird', 'drift', 'duck', 'duplicatenotes', 'eighthNote', 'elapsednotes2', 'f', 'ff', 'fff', 'fill', 'fingercymbals', 'fifth',, 'fifthinterval', 'flat', 'floortom', 'fourth', 'fourthinterval', 'glide', 'halfNote', 'harmonic', 'harmonic2', 'hihat', 'hollowline', 'interval', 'invert', 'invert1', 'kick', 'major2', 'major3', 'major6', 'major7', 'matrix', 'matrixcmajor', 'matrixgmajor', 'meter', 'mf', 'midi', 'minor2', 'minor3', 'minor6', 'minor7', 'movable', 'mp', 'multiplybeatfactor', 'musickeyboard', 'neighbor', 'neighbor2', 'newnote', 'newslur', 'newstaccato', 'newswing', 'newswing2', 'note', 'note1', 'note2', 'note3', 'note4', 'note5', 'note6', 'note7', 'octave', 'oneOf', 'osctime', 'p', 'perfect4', 'perfect5', 'perfect8', 'pickup', 'pitch2', 'pitchdrummatrix', 'pitchslider', 'pitchstaircase', 'playdrum', 'playnoise', 'pp', 'ppp', 'quarterNote', 'rest2', 'rhythm2', 'rhythmicdot', 'rhythmicdot2', 'rhythmruler2', 'rhythmruler3', 'ridebell', 'sawtooth', 'second', 'secondinterval', 'semitoneinterval', 'setbpm', 'setbpm2', 'setdrum', 'setkey2', 'setnotevolume2', 'setsynthvolume', 'setmasterbpm', 'setmasterbpm2', 'settimbre', 'settemperament', 'setscalartransposition', 'settransposition', 'setvoice', 'seventh', 'seventhinterval', 'sharp', 'sine', 'sixteenthNote', 'sixth', 'sixthinterval', 'sixtyfourthNote', 'skipnotes', 'slap', 'slur', 'snare', 'splash', 'square', 'staccato', 'startdrum', 'status', 'storebox1', 'storebox2', 'stuplet', 'stuplet3', 'stuplet5', 'stuplet7', 'swing', 'switch', 'temperament', 'tempo', 'third', 'thirtysecondNote', 'tie', 'timbre', 'tom', 'tone', 'triangle', 'trianglebell', 'tuplet3', 'tuplet4', 'unison', 'unisoninterval', 'vibrato', 'wholeNote', 'black', 'white', 'red', 'orange', 'yellow', 'green', 'blue', 'purple'];
...
function getMacroExpansion (blkname, x, y) {
    ...
    const MUSICKEYBOARDOBJ = [[0, 'musickeyboard', x, y, [null, 1, 16]], [1, 'pitch', 0, 0, [0, 2, 3, 4]], [2, ['solfege', {'value': 'do'}], 0, 0, [1]], [3, ['number', {'value': 4}], 0, 0, [1]], [4, 'pitch', 0, 0, [1, 5, 6, 7]], [5, ['solfege', {'value': 're'}], 0, 0, [4]], [6, ['number', {'value': 4}], 0, 0, [4]], [7, 'pitch', 0, 0, [4, 8, 9, 10]], [8, ['solfege', {'value': 'mi'}], 0, 0, [7]], [9, ['number', {'value': 4}], 0, 0, [7]], [10, 'pitch', 0, 0, [7, 11, 12, 13]], [11, ['solfege', {'value': 'fa'}], 0, 0, [10]], [12, ['number', {'value': 4}], 0, 0, [10]], [13, 'pitch', 0, 0, [10, 14, 15, null]], [14, ['solfege', {'value': 'sol'}], 0, 0, [13]], [15, ['number', {'value': 4}], 0, 0, [13]], [16, 'hiddennoflow', 0, 0, [0, null]]];
    ...
    const BUILTINMACROS = {
        ...
        'musickeyboard': MUSICKEYBOARDOBJ,
