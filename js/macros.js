...
function getMacroExpansion (blkname, x, y) {
    ...
    const CUSTOMPITCHOBJ = [[0, 'pitch', x, y, [null, 1, 2, null]], [1, ['customNote', {'value': 'C'}], 0, 0, [0]], [2, ['number', {'value': 4}], 0, 0, [0]]];
