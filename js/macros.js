...
function getMacroExpansion (blkname, x, y) {
    ...
    const MULTBEATOBJ = [[0, 'multiplybeatfactor', x, y, [null, 1, 4, 5]], [1, 'divide', 0, 1, [0, 2, 3]], [2, ['number', {'value': 2}], 0, 0, [1]], [3, ['number', {'value': 1}], 0, 0, [1]], [4, 'vspace', 0, 0, [0, null]], [5, 'hidden', 0, 0, [0, null]]];
