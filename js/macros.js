...
function getMacroExpansion (blkname, x, y) {
    ...
    const TEMPERAMENTOBJ = [[0, 'temperament', x, y, [null, 1, 2, 5]], [1, ['temperamentname', {'value': 'equal'}], 0, 0, [0]], [2,'pitch',0,0,[0,3,4,null]], [3,['notename',{'value':'G'}],0,0,[2]], [4,['number',{'value':4}],0,0,[2]], [5, 'hiddennoflow', 0, 0, [0, null]]];
