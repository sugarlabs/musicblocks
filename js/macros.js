...
function getMacroExpansion (blkname, x, y) {
    ...
    const REPEATHELP = [[0, ['newnote', {'collapsed': false}], 0, 0, [9, 1, 4, 8]], [1, 'divide', 0, 0, [0, 2, 3]], [2, ['number', {'value': 1}], 0, 0, [1]], [3, ['number', {'value': 4}], 0, 0, [1]], [4, 'vspace', 0, 0, [0, 5]], [5, 'pitch', 0, 0, [4, 6, 7, null]], [6, ['solfege', {'value': 'sol'}], 0, 0, [5]], [7, ['number', {'value': 4}], 0, 0, [5]], [8, 'hidden', 0, 0, [0, null]], [9, 'repeat', 0, 0, [null, 10, 0, null]], [10, ['number', {'value': 4}], 0, 0, [9]]];
