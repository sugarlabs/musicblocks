...
/*
   ...
   platformColor, base64Encode, i18next, createjs, Howler, jQuery,
   ActivityContext, TITLESTRING, _THIS_IS_MUSIC_BLOCKS_, _THIS_IS_TURTLE_BLOCKS_
*/
...
/* exported
   ...
   doUseCamera, format, getTextWidth, hideDOMLabel, httpGet, httpPost,
   HttpRequest, importMembers, isSVGEmpty, prepareMacroExports,
   preparePluginExports, processMacroData, processRawPluginData,
   windowHeight, windowWidth, fnBrowserDetect, waitForReadiness
*/

/**
 * @fileoverview Browser-dependent utility functions for Music Blocks.
 * These functions require a DOM environment (window, document, navigator).
 * Pure logic functions have been moved to js/utils/utils-logic.js.
 */
 ...
 * @requires browser (localStorage, i18next)
 * @function
 ...
 * @requires browser (window, document)
 * @function
 ...
 * @requires browser (window, navigator)
 * @function
 ...
 * @requires browser (fetch, window.server)
 ...
 * @requires browser (XMLHttpRequest, self.location)
 * @constructor
 ...
 * @requires browser (navigator, jQuery)
 * @function
 */
 ...
 * @requires browser (document, createjs, Howler, jQuery, requestAnimationFrame)
 ...
 * @requires browser (confirm, localStorage, document)
 */
 ...
 * @requires browser (navigator, video, canvas)
 */
...
if (typeof module !== "undefined" && module.exports) {
    const UtilsLogic = require("./utils-logic.js");
    module.exports = {
        ...UtilsLogic,
        _,
        format,
