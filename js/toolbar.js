...
class Toolbar {
    ...
    /**
     * Renders the theme select icon and handles direct toggling.
     *
     * @public
     * @param {Object} themeBox - The theme box object.
    ...
    renderThemeSelectIcon(themeBox, themes) {
        ...
        icon.onclick = () => {
            ...
            // Find where we are in the themes array (e.g., ["light", "dark", "highcontrast"])
