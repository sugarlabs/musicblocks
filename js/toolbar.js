    ...
    */
    ...
    init(activity) {
        ...
        if (_THIS_IS_MUSIC_BLOCKS_) {
            strings = [
                ["mb-logo", t("About Music Blocks")],
                ["play", t("Play")],
                ["stop", t("Stop")],
                ["record",t("Record")],
                ["Full screen", t("Full screen")],
                ["FullScreen", t("Full screen")],
                ["Toggle Fullscreen", t("Toggle Fullscreen")],
                ["newFile", t("New project")],
                ["load", t("Load project from file")],
                ["saveButton", t("Save project")],
                ["saveButtonAdvanced", t("Save project as HTML")],
                ["planetIcon", t("Find and share projects")],
                ["planetIconDisabled", t("Offline. Sharing is unavailable")],
                ["toggleAuxBtn", t("Auxiliary menu")],
                ["helpIcon", t("Help")],
                ["runSlowlyIcon", t("Run slowly")],
                ["runStepByStepIcon", t("Run step by step")],
                ["displayStatsIcon", t("Display statistics")],
                ["loadPluginIcon", t("Load plugin")],
                ["delPluginIcon", t("Delete plugin")],
                ["enableHorizScrollIcon", t("Enable horizontal scrolling")],
                ["disableHorizScrollIcon", t("Disable horizontal scrolling")],
                ["themeSelectIcon", t("Change theme")],
                ["light", t("Light Mode")],
                ["dark", t("Dark Mode")],
                ["mergeWithCurrentIcon", t("Merge with current project")],
                ["chooseKeyIcon", t("Set Pitch Preview")],
                ["toggleJavaScriptIcon", t("JavaScript Editor")],
                ["restoreIcon", t("Restore")],
                ["beginnerMode", t("Switch to beginner mode")],
                ["advancedMode", t("Switch to advanced mode")],
                ["languageSelectIcon", t("Select language")],
                ["save-html-beg", t("Save project as HTML"), "innerHTML"],
                ["save-png-beg", t("Save mouse artwork as PNG"), "innerHTML"],
                ["save-html", t("Save project as HTML"), "innerHTML"],
                ["save-midi", t("Save project as MIDI"), "innerHTML"],
                ["save-svg", t("Save mouse artwork as SVG"), "innerHTML"],
                ["save-png", t("Save mouse artwork as PNG"), "innerHTML"],
                ["save-wav", t("Save music as WAV"), "innerHTML"],
                ["save-abc", t("Save sheet music as ABC"), "innerHTML"],
                ["save-ly", t("Save sheet music as Lilypond"), "innerHTML"],
                ["save-mxml", t("Save sheet music as MusicXML"), "innerHTML"],
                ["save-blockartwork-svg", t("Save block artwork as SVG"), "innerHTML"],
                ["save-blockartwork-png", t("Save block artwork as PNG"), "innerHTML"],
                ["new-project", t("Confirm"), "innerHTML"],
                ["enUS", t("English (United States)"), "innerHTML"],
                ["enUK", t("English (United Kingdom)"), "innerHTML"],
                ["ja", t("日本語"), "innerHTML"],
                ["ko", t("한국어"), "innerHTML"],
                ["es", t("español"), "innerHTML"],
                ["pt", t("português"), "innerHTML"],
                ["kana", t("にほんご"), "innerHTML"],
                ["zhCN", t("中文"), "innerHTML"],
                ["th", t("ภาษาไทย"), "innerHTML"],
                ["ayc", t("aymara"), "innerHTML"],
                ["quz", t("quechua"), "innerHTML"],
                ["gug", t("guarani"), "innerHTML"],
                ["hi", t("हिंदी"), "innerHTML"],
                ["ibo", t("igbo"), "innerHTML"],
                ["ar", t("عربى"), "innerHTML"],
                ["te", t("తెలుగు"), "innerHTML"],
                ["he", t("עִברִית"), "innerHTML"],
                ["ur", t("اردو"), "innerHTML"]
            ];

            // Workaround for FF
            strings_ = [
                t("About Music Blocks"),
                t("Play"),
                t("Stop"),
                t("Record"),
                t("Full screen"),
                ...
                t("Save project"),
                t("Save project"),
                t("Find and share projects"),
                t("Offline. Sharing is unavailable"),
                t("Auxiliary menu"),
                t("Help"),
                t("Run slowly"),
                t("Run step by step"),
                ...
                t("Load plugin"),
                t("Delete plugin"),
                t("Enable horizontal scrolling"),
                t("Disable horizontal scrolling"),
                t("Change theme"),               
                t("Light Mode"),
                t("Dark Mode"),
                ...
                t("JavaScript Editor"),
                t("Restore"),
                t("Switch to beginner mode"),
                t("Switch to advanced mode"),
                t("Select language"),
                t("Save project as HTML"),
                t("Save project as MIDI"),
                t("Save mouse artwork as SVG"),
                t("Save mouse artwork as PNG"),
                t("Save music as WAV"),
                t("Save sheet music as ABC"),
                t("Save sheet music as Lilypond"),
                t("Save block artwork as SVG"),
                t("Save block artwork as PNG"),              
                t("Confirm"),
                t("Select language"),
                t("Save project as HTML"),
            ...
            strings = [
                ...
                ["languageSelectIcon", t("Select language")],
                ["save-html-beg", t("Save project as HTML"), "innerHTML"],
                ["save-png-beg", t("Save turtle artwork as PNG"), "innerHTML"],
                ["save-html", t("Save project as HTML"), "innerHTML"],
                ["save-svg", t("Save turtle artwork as SVG"), "innerHTML"],
                ["save-png", t("Save turtle artwork as PNG"), "innerHTML"],
                ["save-blockartwork-svg", t("Save block artwork as SVG"), "innerHTML"],
                ["save-blockartwork-png", t("Save block artwork as PNG"), "innerHTML"],
                ["new-project", t("Confirm"), "innerHTML"],
                ["enUS", t("English (United States)"), "innerHTML"],
    ...
    renderWrapIcon() {
        ...
        let wrapButtonTooltipData = t("Turtle Wrap Off");
        ...
        wrapIcon.onclick = () => {
            WRAP = !WRAP;
            if (WRAP) {
                wrapButtonTooltipData = t("Turtle Wrap Off");
                ...
                wrapButtonTooltipData = t("Turtle Wrap On");
                this.activity.helpfulWheelItems.forEach(ele => {
                    if (ele.label === "Turtle Wrap Off") {
                        ele.display = false;
                    } else if (ele.label === "Turtle Wrap On") {
...
function renderNewProjectConfirmation() {
    ...
    title.innerHTML = `<h2 style="color: #0066FF; font-size: 24px; text-align: left; margin: 0;">${t("New project")}</h2>`;
    newDropdown.appendChild(title);
    const confirmationMessage = document.createElement("div");
    confirmationMessage.innerHTML = `<div id="confirmation-message" style="color: #666666; font-size: 16px; margin-bottom: 24px; text-align: left;">${t("Are you sure you want to create a new project?")}</div>`;
    ...
    confirmationButton.innerHTML = t("Confirm");
