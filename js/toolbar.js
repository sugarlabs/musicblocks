    ...
    init(activity) {
        ...
        if (_THIS_IS_MUSIC_BLOCKS_) {
            strings = [
                ...
                ["helpGuideItem", _("Help"), "textContent"],
                ["shortcutsGuideItem", _("Keyboard shortcuts"), "textContent"],
                ...
                ["save-html-beg", _("Save project as HTML"), "textContent"],
                ["save-png-beg", _("Save mouse artwork as PNG"), "textContent"],
                ["save-html", _("Save project as HTML"), "textContent"],
                ["save-midi", _("Save project as MIDI"), "textContent"],
                ["save-svg", _("Save mouse artwork as SVG"), "textContent"],
                ["save-png", _("Save mouse artwork as PNG"), "textContent"],
                ["save-wav", _("Save music as WAV"), "textContent"],
                ["save-abc", _("Save sheet music as ABC"), "textContent"],
                ["save-ly", _("Save sheet music as Lilypond"), "textContent"],
                ["save-mxml", _("Save sheet music as MusicXML"), "textContent"],
                ["save-blockartwork-svg", _("Save block artwork as SVG"), "textContent"],
                ["save-blockartwork-png", _("Save block artwork as PNG"), "textContent"],
                ["new-project", _("Confirm"), "textContent"]
            ];
            ...
            strings = [
                ...
                ["languageSelectIcon", _("Select language")],
                ["save-html-beg", _("Save project as HTML"), "textContent"],
                ["save-png-beg", _("Save turtle artwork as PNG"), "textContent"],
                ["save-html", _("Save project as HTML"), "textContent"],
                ["save-svg", _("Save turtle artwork as SVG"), "textContent"],
                ["save-png", _("Save turtle artwork as PNG"), "textContent"],
                ["save-blockartwork-svg", _("Save block artwork as SVG"), "textContent"],
                ["save-blockartwork-png", _("Save block artwork as PNG"), "textContent"],
                ["new-project", _("Confirm"), "textContent"]
            ];
