    ...
    init(activity) {
        ...
        if (_THIS_IS_MUSIC_BLOCKS_) {
            strings = [
                ...
                ["save-html-beg", _("Save project as HTML")],
                ["save-png-beg", _("Save mouse artwork as PNG")],
                ["save-html", _("Save project as HTML")],
                ["save-svg", _("Save mouse artwork as SVG")],
                ["save-png", _("Save mouse artwork as PNG")],
                ["save-wav", _("Save music as WAV")],
                ["save-abc", _("Save sheet music as ABC")],
                ["save-ly", _("Save sheet music as Lilypond")],
                ["save-mxml", _("Save sheet music as MusicXML")],
                ["save-blockartwork-svg", _("Save block artwork as SVG")],
                ["save-blockartwork-png", _("Save block artwork as PNG")],
            ...
            strings_ = [
                ...
                _("Save sheet music as MusicXML"),
            ...
            strings = [
                ...
                ["languageSelectIcon", _("Select language")],
                ["save-html-beg", _("Save project as HTML")],
                ["save-png-beg", _("Save turtle artwork as PNG")],
                ["save-html", _("Save project as HTML")],
                ["save-svg", _("Save turtle artwork as SVG")],
                ["save-png", _("Save turtle artwork as PNG")],
                ["save-blockartwork-svg", _("Save block artwork as SVG")],
                ["save-blockartwork-png", _("Save block artwork as PNG")],
                ["new-project", _("Confirm"), "innerHTML"],
                ["enUS", _("English (United States)"), "innerHTML"],
