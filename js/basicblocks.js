...
function initBasicProtoBlocks(palettes, blocks) {
    ...
    var noiseSynth = new ProtoBlock('noisesynth');
    noiseSynth.palette = palettes.dict['tone'];
    blocks.protoBlockDict['noisesynth'] = noise;
    noiseSynth.synthstaticLabels.push(_('noise'));
    noiseSynth.staticLabels.push(_('type'));
    noiseSynth.adjustWidthToLabel();
    noiseSynth.defaults.push(_('white'));
    noiseSynth.oneArgBlock();
    noiseSynth.dockTypes[1] = 'textin';
