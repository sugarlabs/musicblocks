...
const processLilypondNotes = (lilypond, logo, turtle) => {
    ...
    const __toLilynote = (note) => {
        ...
        return note.replace(/[â™®â™¯â™­]|10|[1-9]/g, match => replacements[match]).toLowerCase();
    };
