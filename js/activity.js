...
//document.getElementById("solfamenu").style.visibility = "hidden";
        ...
        var helpIdx = 0;
        var HELPCONTENT = [[_('Welcome to Music Blocks with Mr. Mouse!'), _('Music Blocks a collection of manipulative tools for kids (and adults!) to explore fundamental musical concepts in an integrative and fun way'), 'activity/mouse.svg'],
