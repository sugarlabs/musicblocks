...
let MYDEFINES = [
    ...
    "activity/VersionControlStorage",
    "activity/VersionControlUI",
    "utils/musicutils",
    "utils/synthutils",
    "utils/mathutils",
    "activity/pastebox",
    ...
    constructor() {
        ...
        */
        ...
        this.init = async () => {
            ...
            if (typeof VersionControlStorage !== "undefined" && typeof VersionControlUI !== "undefined") {
                this.versionControlStorage = new VersionControlStorage(this.planet);
                this.versionControlUI = new VersionControlUI(this);

                const initVersionControl = async () => {
                    try {
                        await this.versionControlStorage.init();
                        this.versionControlUI.init(this.versionControlStorage);
                    } catch (e) {
                        // eslint-disable-next-line no-console
                ...
                this.toolbar.renderVersionControlIcon(() => {
                    if (this.versionControlUI) {
                        this.versionControlUI.open();
                    }
                });
            }
