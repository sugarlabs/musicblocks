        ...
        this.transcribeMidi = async function (midi) {
            ...
            currentMidi.tracks.forEach((track, trackIndex) => {
                ...
                if (
                    ...
                    (track.channel == 9 || track.channel == 10) &&
                    precurssionFlag == false
                ) {
                    jsONON.push(
                        ...
                        [110, "hidden", 1120, 1909, [105, 54]],
                        [111, "mapdrum", 1120, 3610, [104, 112, 113, 116]],
                        ...
                        [142, ["notename", { value: "C♯" }], 1208, 3012, [141]],
                        [143, ["number", { value: 5 }], 1208, 3044, [141]],
                ...
                for (let noteIndex in track.notes) {
                    ...
                    if (
                        sched[sched.length - 1].start === start &&
                        sched[sched.length - 1].end === end
                    ) {
            ...
            for (let i = 0; i < trackCount; i++) {
                ...
                if (isPercussion[i]) {
                    jsONON.push(
                        ...
                        [
                            ...
                            0,
                            [
                                len + m + 14 + actionBlockPerTrack[i],
                                len + m + 2,
                                len + m + 3,
                                len + m + 6
                            ]
                        ...
                        [
                            ...
                            0,
                            0,
                            [len + m + 1, len + m + 8 + actionBlockPerTrack[i]]
                        ],
                        [
                            len + m + 7,
                            ["nameddo", { value: "MIDI-conversion" }],
                            0,
                            0,
                            [len + m + 13 + actionBlockPerTrack[i], len + m + 8]
                        ]
                    );
                    flag = false;
                    m += 8;
                    ...
                    jsONON.push(
                        ...
                        [
                            ...
                            0,
                            [
                                len + m + 16 + actionBlockPerTrack[i],
                                len + m + 2,
                                len + m + 3,
                                len + m + 6
                            ]
                        ...
                        [
                            ...
                            0,
                            0,
                            [len + m + 1, len + m + 10 + actionBlockPerTrack[i]]
                        ],
                        [
                            len + m + 7,
                            "settimbre",
                            ...
                            0,
                            [
                                len + m + 15 + actionBlockPerTrack[i],
                                len + m + 8,
                                len + m + 10,
                                len + m + 9
                            ]
                ...
                jsONON.push(
                    ...
                    [
                        setBpmIndex + 1,
                        ["number", { value: currentMidiTempoBpm }],
                        0,
                        0,
                        [setBpmIndex]
                    ],
                    [
                        ...
                        0,
                        0,
                        [setBpmIndex, setBpmIndex + 3, setBpmIndex + 4]
                    ],
