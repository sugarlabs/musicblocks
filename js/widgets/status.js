                ...
                switch (this._logo.statusFields[i][1]) {
                    ...
                    case "bpmfactor":
                        if (localStorage.languagePreference === "ja") {
                            ...
                            label = this._logo.blocks.blockList[this._logo.statusFields[i][0]].protoblock.staticLabels[0];
                        }
                        console.debug(label);
                        break;
                    case "outputtools":
            ...
            for (let t = 0; t < this._logo.turtles.turtleList.length; t++) {
                ...
                for (i = 0; i < this._logo.statusFields.length; i++) {
                    ...
                    switch (this._logo.blocks.blockList[this._logo.statusFields[i][0]].name) {
                        ...
                        case "y":
                        case "heading":
                            value = this._logo.blocks.blockList[this._logo.statusFields[i][0]].value.toFixed(0);
                            break;
                        case "mynotevalue":
                            value = mixedNumber(
                        ...
                        case "elapsednotes":
                            ...
                            break;
                        case "namedbox":
                            name = this._logo.blocks.blockList[this._logo.statusFields[i][0]].privateData;
