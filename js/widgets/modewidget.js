...
class ModeWidget {
    constructor() {
        ...
        this._setMode = function () {
            ...
            let currentModeName = keySignatureToMode(this._logo.turtles.ithTurtle(0).singer.keySignature);
        ...
        this.__playNextNote = function (i) {
            ...
            let currentKey = keySignatureToMode(this._logo.turtles.ithTurtle(0).singer.keySignature)[0];
            if (currentKey === "C") {
                ...
                setTimeout(function () {
                    if (that._lastNotePlayed !== null) {
                        ...
                        if (note_key !== null) {
                            note_key.src =
                                highlightImgs[(that._lastNotePlayed + startingposition) % 12];
                        }
                    }
        ...
        this._piemenuMode = function () {
            ...
            let __setNote = function () {
                ...
                that._playNote(i);
                that._setModeName();
                let currentModeName = keySignatureToMode(that._logo.turtles.ithTurtle(0).singer.keySignature);
                if (currentModeName[0] === "C") {
                    that._showPiano();
                }
            };
