...
class PhraseMaker {
    ...
    init(activity) {
        ...
        widgetWindow.addButton("export-chunk.svg", PhraseMaker.ICONSIZE, _("Save")).onclick =
            async () => {
                // Debounce the save button
        ...
        widgetWindow.addButton("erase-button.svg", PhraseMaker.ICONSIZE, _("Clear")).onclick =
            this._clear.bind(this);

        if (!localStorage.beginnerMode) {
            widgetWindow.addButton("export-button.svg", PhraseMaker.ICONSIZE, _("Export")).onclick =
                this._export.bind(this);
        }

        widgetWindow.addButton("sort.svg", PhraseMaker.ICONSIZE, _("Sort")).onclick =
        ...
        for (let i = 0; i < this.rowLabels.length; i++) {
            ...
            if (this.rowLabels[i] === "print") break;
                ...
                if (
                    ...
                    cell.innerHTML = `${i18nSolfege(this.rowLabels[i])}${this.rowArgs[i]
                        .toString()
                        .sub()}`;
                    noteObj = getNote(
                        this.rowLabels[i],
    ...
    _createColumnPieSubmenu(index, condition, sortedClose) {
        ...
        const __selectionChanged = () => {
            ...
            if (drumName != null) {
                ...
                cell.innerHTML = `${i18nSolfege(this.rowLabels[index])}${this.rowArgs[index]
                    .toString()
                    .sub()}`;
                noteObj = getNote(
        ...
        for (let i = 0; i < this.rowLabels.length; i++) {
            ...
            if (drumName != null) {
                ...
                if (noteIsSolfege(this.rowLabels[i])) {
                    exportLabel.innerHTML = `${i18nSolfege(this.rowLabels[i])}${this.rowArgs[i]
                        .toString()
                        .sub()}`;
                } else {
