    ...
    constructor() {
        ...
        this.init = function (logo) {
            ...
            if (!this.sorted) {
                ...
                for (i = 0; i < this.columnBlocksMap.length; i++) {
                    if (MATRIXGRAPHICS.indexOf(this.columnBlocksMap[i][1]) !== -1 ||
                ...
                if (drumName != null) {
                    ...
                    if (noteName in BELLSETIDX && this.rowArgs[i] === 4) {
                        cell.innerHTML =
                            ...
                            cell.style.width +
                            '" vertical-align="middle">';
                    } else if (["C", "do"].indexOf(noteName) !== -1 &&
                        this.rowArgs[i] === 5) {
                        cell.innerHTML =
                            '<img src="' +
        ...
        this._createMatrixGraphics2PieSubmenu = function (blockIndex, blk) {
            ...
            for (var i = 0; i < _blockNames.length; i++) {
                _blockLabels.push(
                    this._logo.blocks.protoBlockDict[_blockNames[i]]["staticLabels"][0]
                );
            }
            ...
            var __enterArgValue1 = function () {
                that.xblockValue[0] =
                    that._blockLabelsWheel2.navItems[that._blockLabelsWheel2.selectedNavItemIndex].title;
            ...
            var __selectionChanged = async function (updatingArgs) {
                ...
                if (updatingArgs === undefined) {
                    ...
                    var z = that._logo.blocks.blockList[argBlock].container.children
                        .length - 1;
        ...
        this._createColumnPieSubmenu = function (index, condition, sortedClose) {
            ...
            var __selectionChanged = function () {
                var label = that._pitchWheel.navItems[that._pitchWheel.selectedNavItemIndex]
                    .title;
                ...
                if (!that._noteBlocks) {
                    ...
                    var z = that._logo.blocks.blockList[noteLabelBlock].container.children
                        .length - 1;
                ...
                if (condition === "pitchblocks") {
                    ...
                    if (!that._noteBlocks) {
                        that._logo.blocks.blockList[noteLabelBlock].blocks.setPitchOctave(
                ...
                if (drumName != null) {
                    cell.innerHTML = _(drumName);
                    cell.style.fontSize = Math.floor(this._cellScale * 14) + "px";
                } else if (noteIsSolfege(that.rowLabels[i]) &&
        ...
        this._syncMarkedBlocks = function () {
            ...
            for (var i = 0; i < this._blockMap[blk].length; i++) {
                ...
                for (var j = 0; j < this._blockMapHelper.length; j++) {
                    if (JSON.stringify(this._blockMap[blk][i][1]) ===
        ...
        this.blockConnection = function (len, bottomOfClamp) {
            ...
            if (bottomOfClamp == null) {
                ...
                var c = this._logo.blocks.blockList[bottomOfClamp].connections.length -
                    1;
        ...
        this._deleteRhythmBlock = function (blockToDelete) {
            if (last(this._logo.blocks.blockList[blockToDelete].connections) !==
                null) {
                this._logo.blocks.sendStackToTrash(
                    this._logo.blocks.blockList[last(this._logo.blocks.blockList[blockToDelete].connections)]
                );
            }
            this._logo.blocks.sendStackToTrash(
        ...
        this._update = function (i, value, k, noteCase) {
            ...
            if (noteCase === "tupletnote") {
                updates.push(
                    this._logo.blocks.blockList[this._logo.blocks.blockList[i].connections[1]].connections[1]
                );
                updates.push(
                    this._logo.blocks.blockList[this._logo.blocks.blockList[i].connections[1]].connections[2]
                );
            } else {
                updates.push(
                    this._logo.blocks.blockList[this._logo.blocks.blockList[i].connections[2]].connections[1]
                );
                updates.push(
                    this._logo.blocks.blockList[this._logo.blocks.blockList[i].connections[2]].connections[2]
                );
            }
        ...
        this._updateTupletValue = function (
            ...
            if (oldTupletValue < newTupletValue) {
                ...
                for (var i = oldTupletValue; i < newTupletValue; i++) {
                    this._logo.tupletRhythms[noteToDivide] = this._logo.tupletRhythms[noteToDivide]
                ...
                for (var i = oldTupletValue; i > newTupletValue; i--) {
                    this._logo.tupletRhythms[noteToDivide] = this._logo.tupletRhythms[noteToDivide].slice(
                        0,
                        this._logo.tupletRhythms[noteToDivide].length - 1
                    );
                }
                ...
                for (var i = 0; i < this._blockMap[blk].length; i++) {
                    ...
                    if (obj[0] !== -1) {
                        ...
                        for (var j = 0; j < this._rowBlocks.length; j++) {
                            ...
                            var idsliced = this._rowBlocks[j]
                                .toString()
                    ...
                    if (cell.style.backgroundColor === "black") {
                        if (this.rowLabels[j] === "hertz") {
                            ...
                            if (
                                ...
                                note.push(
                                    MATRIXHALFTONES2[MATRIXHALFTONES.indexOf(this.rowLabels[j])] + this.rowArgs[j]
                                );
                            } else {
        ...
        this.__playNote = function (time, noteCounter) {
            ...
            var noteValue = this._notesToPlay[noteCounter][1];
            time = 1 / noteValue;
            var that = this;
            ...
            setTimeout(function () {
                ...
                if (noteCounter === that._notesToPlay.length - 1) {
                    ...
                    var note = that._notesToPlay[that._notesCounter][0];
        ...
        this._setNoteCell = function (j, colIndex, cell, playNote) {
            ...
            if (this.rowLabels[j] === "hertz") {
                ...
                var graphicsBlock = false;
                var graphicNote = note.split(": ");
                if (MATRIXGRAPHICS.indexOf(graphicNote[0]) != -1 &&
