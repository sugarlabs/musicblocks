function TemperamentWidget () {
    ...
    this._save = function() {
        ...
        var newStack1 = [[0,'settemperament', 100, 100, [null, 1, 2, 3, null]], [1, ['temperamentname', {'value': this.inTemperament}], 0, 0, [0]], [2, ['notename', {'value': note}], 0, 0, [0]], [2, ['number', {'value': octave}], 0, 0, [0]]];        
