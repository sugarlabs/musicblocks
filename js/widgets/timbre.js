    ...
    constructor() {
        ...
        this._update = function (i, value, k) {
            ...
            if (this.isActive["vibrato"] === true &&
                ...
                if (this._logo.blocks.blockList[divBlock].name === "divide" &&
                    ...
                    this._logo.blocks.blockList[this._logo.blocks.blockList[divBlock].connections[1]].name === "number" &&
                    this._logo.blocks.blockList[divBlock].connections[2] != null &&
                    this._logo.blocks.blockList[this._logo.blocks.blockList[divBlock].connections[2]].name === "number") {
                    ...
                    let topOfClamp = this._logo.blocks.blockList[last(this.vibratoEffect)].connections[3];
        ...
        this.init = function (logo) {
            ...
            oscillatorButtonCell.onclick = function () {
                ...
                if (that.osc.length === 0) {
                    let topOfClamp = that._logo.blocks.blockList[that.blockNo].connections[2];
        ...
        this._changeBlock = function (newblk, synthChosen, bottomOfClamp) {
            ...
            } else if (this.FMSynthesizer.length !== 0 &&
                synthChosen !== "FMSynth") {
                lastBlk = this.FMSynthesizer.pop();
                setTimeout(this._blockReplace(lastBlk, newblk), 500);
            } else if (this.duoSynthesizer.length !== 0 &&
        ...
        this.blockConnection = function (len, bottomOfClamp) {
            ...
            if (bottomOfClamp == null) {
                ...
                let c = this._logo.blocks.blockList[bottomOfClamp].connections.length -
                    1;
                ...
                while (this._logo.blocks.blockList[bottomOfClamp].name === "hidden" &&
                    this._logo.blocks.blockList[this._logo.blocks.blockList[bottomOfClamp].connections[0]].name !== "newnote") {
                ...
                synthsName[i].onclick = function () {
                    ...
                    if (synthChosen === "AMSynth") {
                        ...
                        if (that.AMSynthesizer.length === 0) {
                            let topOfClamp = that._logo.blocks.blockList[that.blockNo]
                                .connections[2];
                            let bottomOfClamp = that._logo.blocks.findBottomBlock(
                                topOfClamp
                            );
        ...
        this._oscillator = function (newOscillator) {
            ...
            let env = docById("timbreTable");
            let htmlElements = '<div id="wrapperOsc0"><div id="sOsc0"><span>' +
                _("type") +
            ...
            for (let i = 0; i < OSCTYPES.length; i++) {
                ...
                if (OSCTYPES[i][0].length === 0) {
                    if (OSCTYPES[i][0] === this.oscParams[0] ||
        ...
        this._updateFilters = function () {
            ...
            for (let f = 0; f < this.fil.length; f++) {
                ...
                let rolloff = instrumentsFilters[0][this.instrumentName][f]["filterRolloff"];
                if (rolloff === -12) {
                    docById("radio" + radioIDs[0]).checked = true;
                } else {
                    docById("radio" + radioIDs[0]).checked = false;
        ...
        this._addFilter = function () {
            ...
            let selectedFilters = instrumentsFilters[0][this.instrumentName].slice();
                ...
                effectsName[i].onclick = function () {
                    ...
                    if (effectChosen === "Tremolo") {
                        ...
                        if (that.vibratoEffect.length > 0) {
                            ...
                            let topOfTimbreClamp = that._logo.blocks.blockList[that.blockNo]
                                .connections[2];
