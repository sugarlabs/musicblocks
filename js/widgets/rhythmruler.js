...
class RhythmRuler {
    constructor() {
            ...
            if (this._playing) {
                ...
                if (this._tapCell === null) {
                    ...
                    if (this.Drums[this._rulerSelected] === null) {
                        ...
                        let drumBlockNo = this._logo.blocks.blockList[this.Drums[this._rulerSelected]].connections[1];
                    ...
                    setTimeout(function () {
                        that.__startTapping(cell, noteValues, interval);
                    }, interval);
                }
            } else {
                let noteValues = this.Rulers[this._rulerSelected][0];
        ...
        this.__startTapping = function (cell, noteValues, interval) {
            let d = new Date();
        ...
        this.__endTapping = function (cell) {
            ...
            if (typeof this._rulerSelected === "string" ||
                ...
                let sum = 0;
                let obj;
                let interval = this._bpmFactor / Math.abs(noteValues[this._tapCell.cellIndex]);
        ...
        this.__addCellEventHandlers = function (cell, cellWidth, noteValue) {
            ...
            const __mouseOverHandler = function (event) {
                let cell = event.target;
            ...
            const __mouseOutHandler = function (event) {
                let cell = event.target;
                cell.innerHTML = "";
            };
            ...
            const __clickHandler = function (event) {
                if (event == undefined)
                    return;
        ...
        this.__divideFromList = function (cell, newNoteValues, addToUndoList) {
            ...
            if (typeof this._rulerSelected === "string" ||
                ...
                let newNoteValue = noteValues[newCellIndex];
        ...
        this.__dissectByNumber = function (cell, inputNum, addToUndoList) {
            ...
            if (typeof this._rulerSelected === "string" ||
                ...
                let tempwidth = this._noteWidth(newNoteValue);
                let tempwidthPixels = parseFloat(inputNum) * parseFloat(tempwidth) + "px";
                let difference = parseFloat(this._noteWidth(noteValue)) -
        ...
        this._save = function (selectedRuler) {
            ...
            setTimeout(function () {
                ...
                if (that.Drums[selectedRuler] === null) {
                    ...
                    stack_value =
                        that._logo.blocks.blockList[that._logo.blocks.blockList[that.Drums[selectedRuler]]
                            .connections[1]].value.split(" ")[0] +
                        " " +
                        _("rhythm");
                }
                ...
                let sameNoteValue = 1;
                for (let i = 0; i < ruler.cells.length; i++) {
                    if (noteValues[i] === noteValues[i + 1] &&
        ...
        this._saveMachine = function (selectedRuler) {
            ...
            if (this.Drums[selectedRuler] === null) {
                ...
                let drumBlockNo = this._logo.blocks.blockList[this.Drums[selectedRuler]].connections[1];
                drum = this._logo.blocks.blockList[drumBlockNo].value;
            }
        ...
        this._saveVoiceMachine = function (selectedRuler, voice) {
            ...
            setTimeout(function () {
                ...
                if (that.Drums[selectedRuler] === null) {
                    ...
                    let action_name = that._logo.blocks.blockList[that._logo.blocks.blockList[that.Drums[selectedRuler]]
                        .connections[1]].value.split(" ")[0] +
                        "_" +
                        _("action");
                }
                ...
                for (let i = 0; i < this._dissectHistory.length; i++) {
                    ...
                    for (let j = 0; j < this._dissectHistory[i][0].length; j++) {
                        ...
                        if (typeof this._dissectHistory[i][0][j] === "number") {
                            cell =
                                rhythmRulerTableRow.cells[this._dissectHistory[i][0][j]];
                            this.__toggleRestState(cell, false);
                        } else if (typeof this._dissectHistory[i][0][j][0] === "number") {
                            if (typeof this._dissectHistory[i][0][j][1] === "number") {
                                // dissect is [cell, num]
                                cell =
                                    rhythmRulerTableRow.cells[this._dissectHistory[i][0][j][0]];
                                if (cell != undefined) {
