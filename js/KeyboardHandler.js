...
/*
   exported KeyboardHandler
*/

/**
 * Owns Activity keyboard shortcuts and current-key tracking.
 */
class KeyboardHandler {
    ...
    /**
     * Handles the document keydown binding.
    ...
    /**
     * Clears the tracked current key state.
     */
    clearCurrentKeyCode() {
...
if (typeof globalThis !== "undefined") {
    globalThis.KeyboardHandler = KeyboardHandler;
}
