...
class LogoDependencies {
    ...
    static validate(deps) {
        ...
        // blockList/turtleList are not read during construction, so callers
        // (notably lightweight test doubles) may omit them. When present they
        // must be arrays, since Logo indexes and iterates them during execution.
