...
function Logo(matrix, musicnotation, canvas, blocks, turtles, stage,
    ...
    */
    ...
    //TEST NOTE TO NUMBER FUNCTION
    this.getNumber = function(solfege, octave) {
            //initialise number to 0 (from the start)
        ...
        //NOTE TO NUMBER FUNCTION END

    //TEST NUMBER TO NOTE FUNCTION
