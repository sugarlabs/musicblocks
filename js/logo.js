...
function Logo(matrix, canvas, blocks, turtles, stage, refreshCanvas, textMsg, errorMsg,
    ...
    this.pushedNote = {};
    this.inNote = {};
    this.noteTransposition = {};

    this.noteBeatValue = {};

    // parameters used by the pitch block
    ...
    */
    ...
    this.step = function() {
        ...
        for (turtle in this.stepQueue) {
            if (this.stepQueue[turtle].length > 0) {
                ...
                if (blk != null) {
                    console.log('calling runFromBlockNow with ' + blk);
    ...
    this.runLogoCommands = function(startHere , env) {
        ...
        for (var turtle = 0; turtle < this.turtles.turtleList.length; turtle++) {
            ...
            this.noteTransposition[turtle] = 0;
        ...
        if (startHere != null) {
            ...
            console.log('calling runFromBlockNow with ' + startHere);
            ...
            for (var b = 0; b < startBlocks.length; b++) {
                ...
                if (!this.turtles.turtleList[turtle].trash) {
                    ...
                    this.turtles.turtleList[turtle].running = true;
                    console.log('calling runFromBlock with ' + startBlocks[b]);
    ...
    this.runFromBlockNow = function(logo, turtle, blk, isflow, receivedArg) {
        ...
        console.log(logo.blocks.blockList[blk].name + ' (' + blk + '): ');
        console.log(args);
            ...
            case 'pitch':
                ...
                if (logo.inNote[turtle]) {
                    ...
                    if (turtle in logo.transposition) {
                        ...
                        console.log('pitch (' + blk + '): pushing ' + args[0] + ' ' + args[1] + ' ' + logo.transposition[turtle]);
                    } else {
                        logo.noteTranspositions[turtle].push(0);
                        console.log('pitch (' + blk + '): pushing ' + args[0] + ' ' + args[1] + ' ' + 0);
                    }
