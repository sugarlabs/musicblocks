...
function Palette(palettes, name) {
    ...
    this._makeBlockFromProtoblock = function(protoblk, moved, blkname, event, saveX, saveY) {
        ...
        const TEMPOOBJ = [[0, 'tempo', this.protoContainers[blkname].x - paletteBlocks.stage.x, this.protoContainers[blkname].y - paletteBlocks.stage.y, [null, 1, 2, 4]], [1, ['number', {'value': 2}], 0, 0, [0]], [2, 'setmasterbpm', 0, 0, [0, 3, null]], [3, ['number', {'value': 90}], 0, 0, [2]], [4, 'hidden', 0, 0, [0, null]]]; 
