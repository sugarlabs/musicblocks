...
function Palette(palettes, name) {
    ...
    this._makeBlockFromProtoblock = function(protoblk, moved, blkname, event, saveX, saveY) {
        ...
        const PITCHSLIDEROBJ = [[0, 'pitchslider', this.protoContainers[blkname].x - paletteBlocks.stage.x, this.protoContainers[blkname].y - paletteBlocks.stage.y, [null, 1, 3]], [1, 'sine', 0, 0, [0, 2, null]], [2, ['number', {'value': 220}], 0, 0, [1]], [3, 'hidden', 0, 0, [0, null]]]; 
